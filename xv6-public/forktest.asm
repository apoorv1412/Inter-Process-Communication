...
main(void)
{
  ...
  exit();
  16:	e8 60 04 00 00       	call   47b <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
...
00000020 <printf>:
{
  ...
  38:	e8 5e 04 00 00       	call   49b <write>
}
  ...
  54:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  59:	68 24 05 00 00       	push   $0x524
  5e:	e8 6d 01 00 00       	call   1d0 <strlen>
  63:	83 c4 0c             	add    $0xc,%esp
  66:	50                   	push   %eax
  67:	68 24 05 00 00       	push   $0x524
  6c:	6a 01                	push   $0x1
  6e:	e8 28 04 00 00       	call   49b <write>
  ...
  8f:	74 4f                	je     e0 <forktest+0x90>
    pid = fork();
  91:	e8 dd 03 00 00       	call   473 <fork>
    if(pid < 0)
  ...
  9e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  a0:	e8 de 03 00 00       	call   483 <wait>
  ...
  e3:	68 64 05 00 00       	push   $0x564
  e8:	e8 e3 00 00 00       	call   1d0 <strlen>
  ed:	83 c4 0c             	add    $0xc,%esp
  f0:	50                   	push   %eax
  f1:	68 64 05 00 00       	push   $0x564
  f6:	6a 01                	push   $0x1
  f8:	e8 9e 03 00 00       	call   49b <write>
    exit();
  fd:	e8 79 03 00 00       	call   47b <exit>
      exit();
 102:	e8 74 03 00 00       	call   47b <exit>
  write(fd, s, strlen(s));
 107:	83 ec 0c             	sub    $0xc,%esp
 10a:	68 2f 05 00 00       	push   $0x52f
 10f:	e8 bc 00 00 00       	call   1d0 <strlen>
 114:	83 c4 0c             	add    $0xc,%esp
 117:	50                   	push   %eax
 118:	68 2f 05 00 00       	push   $0x52f
 11d:	6a 01                	push   $0x1
 11f:	e8 77 03 00 00       	call   49b <write>
      exit();
 124:	e8 52 03 00 00       	call   47b <exit>
  write(fd, s, strlen(s));
 129:	83 ec 0c             	sub    $0xc,%esp
 12c:	68 43 05 00 00       	push   $0x543
 131:	e8 9a 00 00 00       	call   1d0 <strlen>
 136:	83 c4 0c             	add    $0xc,%esp
 139:	50                   	push   %eax
 13a:	68 43 05 00 00       	push   $0x543
 13f:	6a 01                	push   $0x1
 141:	e8 55 03 00 00       	call   49b <write>
    exit();
 146:	e8 30 03 00 00       	call   47b <exit>
 ...
 268:	89 f3                	mov    %esi,%ebx
{
 ...
 280:	50                   	push   %eax
 281:	6a 00                	push   $0x0
 283:	e8 0b 02 00 00       	call   493 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ed:	e8 c9 01 00 00       	call   4bb <open>
  if(fd < 0)
 ...
 301:	50                   	push   %eax
 302:	e8 cc 01 00 00       	call   4d3 <fstat>
  close(fd);
 307:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 30a:	89 c6                	mov    %eax,%esi
  close(fd);
 30c:	e8 92 01 00 00       	call   4a3 <close>
  return r;
 ...
 3a1:	31 c9                	xor    %ecx,%ecx
{
 ...
 3a5:	56                   	push   %esi
 3a6:	53                   	push   %ebx
 3a7:	8b 75 0c             	mov    0xc(%ebp),%esi
 3aa:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char* temp = va;
  while (*buff != '.')
 3ad:	89 f0                	mov    %esi,%eax
 3af:	0f b6 13             	movzbl (%ebx),%edx
 3b2:	eb 09                	jmp    3bd <writeBuffer+0x1d>
 3b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  {
    if (*va == 'A')
 3b8:	80 38 41             	cmpb   $0x41,(%eax)
 3bb:	74 13                	je     3d0 <writeBuffer+0x30>
  while (*buff != '.')
 3bd:	80 fa 2e             	cmp    $0x2e,%dl
 3c0:	75 f6                	jne    3b8 <writeBuffer+0x18>
        va = temp;
      else
        va++;
    }
 ...
 3db:	81 e1 ff 0f 00 00    	and    $0xfff,%ecx
 3e1:	0f 44 c6             	cmove  %esi,%eax
 3e4:	eb c9                	jmp    3af <writeBuffer+0xf>
 ...
 3f8:	31 db                	xor    %ebx,%ebx
{
 ...
 405:	74 40                	je     447 <readBuffer+0x57>
 407:	89 f6                	mov    %esi,%esi
 409:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  {
    if (*va != 'A')
 410:	3c 41                	cmp    $0x41,%al
 412:	74 fc                	je     410 <readBuffer+0x20>
    {
      printf(1,"%c", *va);
 414:	83 ec 04             	sub    $0x4,%esp
      ...
      if (x == 0)
        ...
        va++;
 417:	83 c7 01             	add    $0x1,%edi
      c++; 
 41a:	83 c3 01             	add    $0x1,%ebx
      printf(1,"%c", *va);
 41d:	50                   	push   %eax
 41e:	68 83 05 00 00       	push   $0x583
 423:	6a 01                	push   $0x1
 425:	e8 f6 fb ff ff       	call   20 <printf>
      x = (x+1)%4096;
 42a:	8d 56 01             	lea    0x1(%esi),%edx
      *va = 'A';
 42d:	c6 47 ff 41          	movb   $0x41,-0x1(%edi)
      if (x == 0)
 431:	83 c4 10             	add    $0x10,%esp
        va++;
 434:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 43a:	0f 44 7d 08          	cmove  0x8(%ebp),%edi
 43e:	89 d6                	mov    %edx,%esi
  while (*va != '.')
 440:	0f be 07             	movsbl (%edi),%eax
 443:	3c 2e                	cmp    $0x2e,%al
 445:	75 c9                	jne    410 <readBuffer+0x20>
    }
  }
  printf(1,"\n");
 447:	83 ec 08             	sub    $0x8,%esp
 44a:	68 62 05 00 00       	push   $0x562
 44f:	6a 01                	push   $0x1
 451:	e8 ca fb ff ff       	call   20 <printf>
  printf(1,"The value of the counter is %d\n", c);
 456:	83 c4 0c             	add    $0xc,%esp
 459:	53                   	push   %ebx
 45a:	68 88 05 00 00       	push   $0x588
 45f:	6a 01                	push   $0x1
 461:	e8 ba fb ff ff       	call   20 <printf>
  return 1;
