...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 90 39 00 00       	call   39bb <open>
    ...
    exit();
      40:	e8 36 39 00 00       	call   397b <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 65 39 00 00       	call   39bb <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 45 39 00 00       	call   39a3 <close>
  ...
  exit();
     10d:	e8 69 38 00 00       	call   397b <exit>
...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     13d:	e8 a1 38 00 00       	call   39e3 <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 95 38 00 00       	call   39eb <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 5d 38 00 00       	call   39cb <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 69 38 00 00       	call   39eb <chdir>
  ...
  printf(stdout, "iput test ok\n");
    ...
    exit();
     1b3:	e8 c3 37 00 00       	call   397b <exit>
    ...
    exit();
     1ca:	e8 ac 37 00 00       	call   397b <exit>
    ...
    exit();
     1e1:	e8 95 37 00 00       	call   397b <exit>
    ...
    exit();
     1f8:	e8 7e 37 00 00       	call   397b <exit>
...
00000200 <exitiputtest>:
{
  ...
  pid = fork();
     216:	e8 58 37 00 00       	call   3973 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 ae 37 00 00       	call   39e3 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 9e 37 00 00       	call   39eb <chdir>
     24d:	83 c4 10             	add    $0x10,%esp
     250:	85 c0                	test   %eax,%eax
     252:	78 6b                	js     2bf <exitiputtest+0xbf>
    if(unlink("../iputdir") < 0){
     254:	83 ec 0c             	sub    $0xc,%esp
     257:	68 4c 3e 00 00       	push   $0x3e4c
     25c:	e8 6a 37 00 00       	call   39cb <unlink>
     261:	83 c4 10             	add    $0x10,%esp
     264:	85 c0                	test   %eax,%eax
     266:	78 28                	js     290 <exitiputtest+0x90>
    exit();
     268:	e8 0e 37 00 00       	call   397b <exit>
     26d:	8d 76 00             	lea    0x0(%esi),%esi
  wait();
     270:	e8 0e 37 00 00       	call   3983 <wait>
  printf(stdout, "exitiput test ok\n");
     275:	83 ec 08             	sub    $0x8,%esp
     278:	68 a6 3e 00 00       	push   $0x3ea6
     27d:	ff 35 54 5f 00 00    	pushl  0x5f54
     ...
     293:	68 57 3e 00 00       	push   $0x3e57
     298:	ff 35 54 5f 00 00    	pushl  0x5f54
     29e:	e8 2d 38 00 00       	call   3ad0 <printf>
      exit();
     2a3:	e8 d3 36 00 00       	call   397b <exit>
    printf(stdout, "fork failed\n");
     2a8:	51                   	push   %ecx
     2a9:	51                   	push   %ecx
     2aa:	68 69 4d 00 00       	push   $0x4d69
     2af:	ff 35 54 5f 00 00    	pushl  0x5f54
     2b5:	e8 16 38 00 00       	call   3ad0 <printf>
    exit();
     2ba:	e8 bc 36 00 00       	call   397b <exit>
      printf(stdout, "child chdir failed\n");
     2bf:	50                   	push   %eax
     2c0:	50                   	push   %eax
     2c1:	68 92 3e 00 00       	push   $0x3e92
     2c6:	ff 35 54 5f 00 00    	pushl  0x5f54
     2cc:	e8 ff 37 00 00       	call   3ad0 <printf>
      exit();
     2d1:	e8 a5 36 00 00       	call   397b <exit>
      printf(stdout, "mkdir failed\n");
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     2d8:	68 28 3e 00 00       	push   $0x3e28
     2dd:	ff 35 54 5f 00 00    	pushl  0x5f54
     2e3:	e8 e8 37 00 00       	call   3ad0 <printf>
      exit();
     2e8:	e8 8e 36 00 00       	call   397b <exit>
...
000002f0 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2f6:	68 b8 3e 00 00       	push   $0x3eb8
     2fb:	ff 35 54 5f 00 00    	pushl  0x5f54
     301:	e8 ca 37 00 00       	call   3ad0 <printf>
  if(mkdir("oidir") < 0){
     306:	c7 04 24 c7 3e 00 00 	movl   $0x3ec7,(%esp)
     30d:	e8 d1 36 00 00       	call   39e3 <mkdir>
     312:	83 c4 10             	add    $0x10,%esp
     315:	85 c0                	test   %eax,%eax
     317:	0f 88 88 00 00 00    	js     3a5 <openiputtest+0xb5>
  pid = fork();
     31d:	e8 51 36 00 00       	call   3973 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     32f:	6a 02                	push   $0x2
     331:	68 c7 3e 00 00       	push   $0x3ec7
     336:	e8 80 36 00 00       	call   39bb <open>
    if(fd >= 0){
     ...
     345:	68 4c 4e 00 00       	push   $0x4e4c
     34a:	ff 35 54 5f 00 00    	pushl  0x5f54
     350:	e8 7b 37 00 00       	call   3ad0 <printf>
      exit();
     355:	e8 21 36 00 00       	call   397b <exit>
     35a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  sleep(1);
     360:	83 ec 0c             	sub    $0xc,%esp
     363:	6a 01                	push   $0x1
     365:	e8 a1 36 00 00       	call   3a0b <sleep>
  if(unlink("oidir") != 0){
     36a:	c7 04 24 c7 3e 00 00 	movl   $0x3ec7,(%esp)
     371:	e8 55 36 00 00       	call   39cb <unlink>
     376:	83 c4 10             	add    $0x10,%esp
     379:	85 c0                	test   %eax,%eax
     37b:	75 56                	jne    3d3 <openiputtest+0xe3>
  wait();
     37d:	e8 01 36 00 00       	call   3983 <wait>
  printf(stdout, "openiput test ok\n");
     382:	83 ec 08             	sub    $0x8,%esp
     385:	68 f0 3e 00 00       	push   $0x3ef0
     38a:	ff 35 54 5f 00 00    	pushl  0x5f54
    ...
    exit();
     3a0:	e8 d6 35 00 00       	call   397b <exit>
    printf(stdout, "mkdir oidir failed\n");
     3a5:	51                   	push   %ecx
     3a6:	51                   	push   %ecx
     3a7:	68 cd 3e 00 00       	push   $0x3ecd
     3ac:	ff 35 54 5f 00 00    	pushl  0x5f54
     3b2:	e8 19 37 00 00       	call   3ad0 <printf>
    exit();
     3b7:	e8 bf 35 00 00       	call   397b <exit>
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
     3be:	68 69 4d 00 00       	push   $0x4d69
     3c3:	ff 35 54 5f 00 00    	pushl  0x5f54
     3c9:	e8 02 37 00 00       	call   3ad0 <printf>
    exit();
     3ce:	e8 a8 35 00 00       	call   397b <exit>
    printf(stdout, "unlink failed\n");
     3d3:	50                   	push   %eax
     3d4:	50                   	push   %eax
     3d5:	68 e1 3e 00 00       	push   $0x3ee1
     3da:	ff 35 54 5f 00 00    	pushl  0x5f54
     3e0:	e8 eb 36 00 00       	call   3ad0 <printf>
    exit();
     3e5:	e8 91 35 00 00       	call   397b <exit>
...
000003f0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3f6:	68 02 3f 00 00       	push   $0x3f02
     3fb:	ff 35 54 5f 00 00    	pushl  0x5f54
     401:	e8 ca 36 00 00       	call   3ad0 <printf>
  fd = open("echo", 0);
     406:	58                   	pop    %eax
     407:	5a                   	pop    %edx
     408:	6a 00                	push   $0x0
     40a:	68 0d 3f 00 00       	push   $0x3f0d
     40f:	e8 a7 35 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     41e:	50                   	push   %eax
     41f:	e8 7f 35 00 00       	call   39a3 <close>
  fd = open("doesnotexist", 0);
     424:	5a                   	pop    %edx
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 25 3f 00 00       	push   $0x3f25
     42d:	e8 89 35 00 00       	call   39bb <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     43c:	68 50 3f 00 00       	push   $0x3f50
     441:	ff 35 54 5f 00 00    	pushl  0x5f54
    ...
    printf(stdout, "open echo failed!\n");
     451:	50                   	push   %eax
     452:	50                   	push   %eax
     453:	68 12 3f 00 00       	push   $0x3f12
     458:	ff 35 54 5f 00 00    	pushl  0x5f54
     45e:	e8 6d 36 00 00       	call   3ad0 <printf>
    exit();
     463:	e8 13 35 00 00       	call   397b <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     468:	50                   	push   %eax
     469:	50                   	push   %eax
     46a:	68 32 3f 00 00       	push   $0x3f32
     46f:	ff 35 54 5f 00 00    	pushl  0x5f54
     475:	e8 56 36 00 00       	call   3ad0 <printf>
    exit();
     47a:	e8 fc 34 00 00       	call   397b <exit>
     47f:	90                   	nop
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     488:	68 5e 3f 00 00       	push   $0x3f5e
     48d:	ff 35 54 5f 00 00    	pushl  0x5f54
     493:	e8 38 36 00 00       	call   3ad0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     498:	58                   	pop    %eax
     499:	5a                   	pop    %edx
     49a:	68 02 02 00 00       	push   $0x202
     49f:	68 6f 3f 00 00       	push   $0x3f6f
     4a4:	e8 12 35 00 00       	call   39bb <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4bb:	68 75 3f 00 00       	push   $0x3f75
     4c0:	ff 35 54 5f 00 00    	pushl  0x5f54
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4d3:	6a 0a                	push   $0xa
     4d5:	68 ac 3f 00 00       	push   $0x3fac
     4da:	56                   	push   %esi
     4db:	e8 bb 34 00 00       	call   399b <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4ef:	6a 0a                	push   $0xa
     4f1:	68 b7 3f 00 00       	push   $0x3fb7
     4f6:	56                   	push   %esi
     4f7:	e8 9f 34 00 00       	call   399b <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     513:	68 c2 3f 00 00       	push   $0x3fc2
     518:	ff 35 54 5f 00 00    	pushl  0x5f54
     51e:	e8 ad 35 00 00       	call   3ad0 <printf>
  close(fd);
     523:	89 34 24             	mov    %esi,(%esp)
     526:	e8 78 34 00 00       	call   39a3 <close>
  fd = open("small", O_RDONLY);
     52b:	5b                   	pop    %ebx
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 6f 3f 00 00       	push   $0x3f6f
     534:	e8 82 34 00 00       	call   39bb <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     549:	68 cd 3f 00 00       	push   $0x3fcd
     54e:	ff 35 54 5f 00 00    	pushl  0x5f54
  ...
  i = read(fd, buf, 2000);
     ...
     566:	53                   	push   %ebx
     567:	e8 27 34 00 00       	call   3993 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     57d:	68 01 40 00 00       	push   $0x4001
     582:	ff 35 54 5f 00 00    	pushl  0x5f54
     588:	e8 43 35 00 00       	call   3ad0 <printf>
  close(fd);
     58d:	89 1c 24             	mov    %ebx,(%esp)
     590:	e8 0e 34 00 00       	call   39a3 <close>
  if(unlink("small") < 0){
     595:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
     59c:	e8 2a 34 00 00       	call   39cb <unlink>
     5a1:	83 c4 10             	add    $0x10,%esp
     5a4:	85 c0                	test   %eax,%eax
     5a6:	78 7d                	js     625 <writetest+0x1a5>
  printf(stdout, "small file test ok\n");
     5a8:	83 ec 08             	sub    $0x8,%esp
     5ab:	68 29 40 00 00       	push   $0x4029
     5b0:	ff 35 54 5f 00 00    	pushl  0x5f54
     ...
     5c8:	53                   	push   %ebx
     5c9:	68 70 4e 00 00       	push   $0x4e70
     5ce:	ff 35 54 5f 00 00    	pushl  0x5f54
     5d4:	e8 f7 34 00 00       	call   3ad0 <printf>
      exit();
     5d9:	e8 9d 33 00 00       	call   397b <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5de:	83 ec 04             	sub    $0x4,%esp
     5e1:	53                   	push   %ebx
     5e2:	68 94 4e 00 00       	push   $0x4e94
     5e7:	ff 35 54 5f 00 00    	pushl  0x5f54
     5ed:	e8 de 34 00 00       	call   3ad0 <printf>
      exit();
     5f2:	e8 84 33 00 00       	call   397b <exit>
    printf(stdout, "error: open small failed!\n");
     5f7:	51                   	push   %ecx
     5f8:	51                   	push   %ecx
     5f9:	68 e6 3f 00 00       	push   $0x3fe6
     5fe:	ff 35 54 5f 00 00    	pushl  0x5f54
     604:	e8 c7 34 00 00       	call   3ad0 <printf>
    exit();
     609:	e8 6d 33 00 00       	call   397b <exit>
    printf(stdout, "read failed\n");
     60e:	52                   	push   %edx
     60f:	52                   	push   %edx
     610:	68 2d 43 00 00       	push   $0x432d
     615:	ff 35 54 5f 00 00    	pushl  0x5f54
     61b:	e8 b0 34 00 00       	call   3ad0 <printf>
    exit();
     620:	e8 56 33 00 00       	call   397b <exit>
    printf(stdout, "unlink small failed\n");
     625:	50                   	push   %eax
     626:	50                   	push   %eax
     627:	68 14 40 00 00       	push   $0x4014
     62c:	ff 35 54 5f 00 00    	pushl  0x5f54
     632:	e8 99 34 00 00       	call   3ad0 <printf>
    exit();
     637:	e8 3f 33 00 00       	call   397b <exit>
    printf(stdout, "error: creat small failed!\n");
     63c:	50                   	push   %eax
     63d:	50                   	push   %eax
     63e:	68 90 3f 00 00       	push   $0x3f90
     643:	ff 35 54 5f 00 00    	pushl  0x5f54
     649:	e8 82 34 00 00       	call   3ad0 <printf>
    exit();
     64e:	e8 28 33 00 00       	call   397b <exit>
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     66d:	ff 35 54 5f 00 00    	pushl  0x5f54
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     684:	e8 32 33 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6b3:	56                   	push   %esi
     6b4:	e8 e2 32 00 00       	call   399b <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 c8 32 00 00       	call   39a3 <close>
  fd = open("big", O_RDONLY);
     6db:	5b                   	pop    %ebx
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 b7 40 00 00       	push   $0x40b7
     6e4:	e8 d2 32 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     724:	56                   	push   %esi
     725:	e8 69 32 00 00       	call   3993 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     740:	56                   	push   %esi
     741:	e8 5d 32 00 00       	call   39a3 <close>
  if(unlink("big") < 0){
     746:	c7 04 24 b7 40 00 00 	movl   $0x40b7,(%esp)
     74d:	e8 79 32 00 00       	call   39cb <unlink>
     752:	83 c4 10             	add    $0x10,%esp
     755:	85 c0                	test   %eax,%eax
     757:	0f 88 af 00 00 00    	js     80c <writetest1+0x1ac>
  printf(stdout, "big files ok\n");
     75d:	83 ec 08             	sub    $0x8,%esp
     760:	68 de 40 00 00       	push   $0x40de
     765:	ff 35 54 5f 00 00    	pushl  0x5f54
     ...
     77d:	53                   	push   %ebx
     77e:	68 67 40 00 00       	push   $0x4067
     783:	ff 35 54 5f 00 00    	pushl  0x5f54
     789:	e8 42 33 00 00       	call   3ad0 <printf>
      exit();
     78e:	e8 e8 31 00 00       	call   397b <exit>
      printf(stdout, "read content of block %d is %d\n",
     793:	50                   	push   %eax
     794:	53                   	push   %ebx
     795:	68 b8 4e 00 00       	push   $0x4eb8
     79a:	ff 35 54 5f 00 00    	pushl  0x5f54
     7a0:	e8 2b 33 00 00       	call   3ad0 <printf>
      exit();
     7a5:	e8 d1 31 00 00       	call   397b <exit>
      printf(stdout, "read failed %d\n", i);
     7aa:	83 ec 04             	sub    $0x4,%esp
     7ad:	50                   	push   %eax
     7ae:	68 bb 40 00 00       	push   $0x40bb
     7b3:	ff 35 54 5f 00 00    	pushl  0x5f54
     7b9:	e8 12 33 00 00       	call   3ad0 <printf>
      exit();
     7be:	e8 b8 31 00 00       	call   397b <exit>
        printf(stdout, "read only %d blocks from big", n);
     7c3:	52                   	push   %edx
     7c4:	68 8b 00 00 00       	push   $0x8b
     7c9:	68 9e 40 00 00       	push   $0x409e
     7ce:	ff 35 54 5f 00 00    	pushl  0x5f54
     7d4:	e8 f7 32 00 00       	call   3ad0 <printf>
        exit();
     7d9:	e8 9d 31 00 00       	call   397b <exit>
    printf(stdout, "error: open big failed!\n");
     7de:	51                   	push   %ecx
     7df:	51                   	push   %ecx
     7e0:	68 85 40 00 00       	push   $0x4085
     7e5:	ff 35 54 5f 00 00    	pushl  0x5f54
     7eb:	e8 e0 32 00 00       	call   3ad0 <printf>
    exit();
     7f0:	e8 86 31 00 00       	call   397b <exit>
    printf(stdout, "error: creat big failed!\n");
     7f5:	50                   	push   %eax
     7f6:	50                   	push   %eax
     7f7:	68 4d 40 00 00       	push   $0x404d
     7fc:	ff 35 54 5f 00 00    	pushl  0x5f54
     802:	e8 c9 32 00 00       	call   3ad0 <printf>
    exit();
     807:	e8 6f 31 00 00       	call   397b <exit>
    printf(stdout, "unlink big failed\n");
     80c:	50                   	push   %eax
     80d:	50                   	push   %eax
     80e:	68 cb 40 00 00       	push   $0x40cb
     813:	ff 35 54 5f 00 00    	pushl  0x5f54
     819:	e8 b2 32 00 00       	call   3ad0 <printf>
    exit();
     81e:	e8 58 31 00 00       	call   397b <exit>
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 d8 4e 00 00       	push   $0x4ed8
     841:	ff 35 54 5f 00 00    	pushl  0x5f54
  ...
  name[2] = '\0';
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     876:	e8 40 31 00 00       	call   39bb <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 20 31 00 00       	call   39a3 <close>
  for(i = 0; i < 52; i++){
  ...
  name[2] = '\0';
    ...
    unlink(name);
     ...
     8b1:	e8 15 31 00 00       	call   39cb <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c1:	68 00 4f 00 00       	push   $0x4f00
     8c6:	ff 35 54 5f 00 00    	pushl  0x5f54
...
000008e0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     911:	e8 d5 30 00 00       	call   39eb <chdir>
  ...
  if(chdir("..") < 0){
     ...
     929:	e8 bd 30 00 00       	call   39eb <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     93d:	e8 89 30 00 00       	call   39cb <unlink>
     942:	83 c4 10             	add    $0x10,%esp
     945:	85 c0                	test   %eax,%eax
     947:	78 2f                	js     978 <dirtest+0x98>
  printf(stdout, "mkdir test ok\n");
     949:	83 ec 08             	sub    $0x8,%esp
     94c:	68 35 41 00 00       	push   $0x4135
     951:	ff 35 54 5f 00 00    	pushl  0x5f54
    ...
    printf(stdout, "mkdir failed\n");
     961:	50                   	push   %eax
     962:	50                   	push   %eax
     963:	68 28 3e 00 00       	push   $0x3e28
     968:	ff 35 54 5f 00 00    	pushl  0x5f54
     96e:	e8 5d 31 00 00       	call   3ad0 <printf>
    exit();
     973:	e8 03 30 00 00       	call   397b <exit>
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 21 41 00 00       	push   $0x4121
     97f:	ff 35 54 5f 00 00    	pushl  0x5f54
     985:	e8 46 31 00 00       	call   3ad0 <printf>
    exit();
     98a:	e8 ec 2f 00 00       	call   397b <exit>
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 10 41 00 00       	push   $0x4110
     996:	ff 35 54 5f 00 00    	pushl  0x5f54
     99c:	e8 2f 31 00 00       	call   3ad0 <printf>
    exit();
     9a1:	e8 d5 2f 00 00       	call   397b <exit>
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 fd 40 00 00       	push   $0x40fd
     9ad:	ff 35 54 5f 00 00    	pushl  0x5f54
     9b3:	e8 18 31 00 00       	call   3ad0 <printf>
    exit();
     9b8:	e8 be 2f 00 00       	call   397b <exit>
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9cb:	ff 35 54 5f 00 00    	pushl  0x5f54
     9d1:	e8 fa 30 00 00       	call   3ad0 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 58 5f 00 00       	push   $0x5f58
     9dd:	68 0d 3f 00 00       	push   $0x3f0d
     9e2:	e8 cc 2f 00 00       	call   39b3 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9f7:	ff 35 54 5f 00 00    	pushl  0x5f54
     9fd:	e8 ce 30 00 00       	call   3ad0 <printf>
    exit();
     a02:	e8 74 2f 00 00       	call   397b <exit>
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a4e:	e8 50 2f 00 00       	call   39a3 <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a69:	e8 25 2f 00 00       	call   3993 <read>
     ...
     aaa:	68 7e 41 00 00       	push   $0x417e
     aaf:	6a 01                	push   $0x1
     ab1:	e8 1a 30 00 00       	call   3ad0 <printf>
          return;
    ...
    close(fds[0]);
     ...
     ace:	e8 d0 2e 00 00       	call   39a3 <close>
     ...
     ade:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ae0:	88 84 03 40 87 00 00 	mov    %al,0x8740(%ebx,%eax,1)
     ...
     af6:	68 40 87 00 00       	push   $0x8740
     afb:	ff 75 e4             	pushl  -0x1c(%ebp)
     afe:	e8 98 2e 00 00       	call   399b <write>
    ...
    exit();
     b1f:	e8 57 2e 00 00       	call   397b <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b33:	e8 6b 2e 00 00       	call   39a3 <close>
    wait();
     b38:	e8 46 2e 00 00       	call   3983 <wait>
  printf(1, "pipe1 ok\n");
     b3d:	5a                   	pop    %edx
     b3e:	59                   	pop    %ecx
     b3f:	68 a3 41 00 00       	push   $0x41a3
     b44:	6a 01                	push   $0x1
     ...
     b5a:	68 8c 41 00 00       	push   $0x418c
     b5f:	6a 01                	push   $0x1
     b61:	e8 6a 2f 00 00       	call   3ad0 <printf>
      exit();
     b66:	e8 10 2e 00 00       	call   397b <exit>
    printf(1, "pipe() failed\n");
     b6b:	57                   	push   %edi
     b6c:	57                   	push   %edi
     b6d:	68 61 41 00 00       	push   $0x4161
     b72:	6a 01                	push   $0x1
     b74:	e8 57 2f 00 00       	call   3ad0 <printf>
    exit();
     b79:	e8 fd 2d 00 00       	call   397b <exit>
    printf(1, "fork() failed\n");
     b7e:	50                   	push   %eax
     b7f:	50                   	push   %eax
     b80:	68 ad 41 00 00       	push   $0x41ad
     b85:	6a 01                	push   $0x1
     b87:	e8 44 2f 00 00       	call   3ad0 <printf>
    exit();
     b8c:	e8 ea 2d 00 00       	call   397b <exit>
        printf(1, "pipe1 oops 1\n");
     b91:	56                   	push   %esi
     b92:	56                   	push   %esi
     b93:	68 70 41 00 00       	push   $0x4170
     b98:	6a 01                	push   $0x1
     b9a:	e8 31 2f 00 00       	call   3ad0 <printf>
        exit();
     b9f:	e8 d7 2d 00 00       	call   397b <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 a9 2d 00 00       	call   3973 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bd5:	e8 99 2d 00 00       	call   3973 <fork>
  if(pid2 == 0)
  ...
  pipe(pfds);
     ...
     be8:	50                   	push   %eax
     be9:	e8 9d 2d 00 00       	call   398b <pipe>
  pid3 = fork();
     bee:	e8 80 2d 00 00       	call   3973 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c02:	e8 9c 2d 00 00       	call   39a3 <close>
    if(write(pfds[1], "x", 1) != 1)
     c07:	83 c4 0c             	add    $0xc,%esp
     c0a:	6a 01                	push   $0x1
     c0c:	68 81 47 00 00       	push   $0x4781
     c11:	ff 75 e4             	pushl  -0x1c(%ebp)
     c14:	e8 82 2d 00 00       	call   399b <write>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c6a:	50                   	push   %eax
     c6b:	50                   	push   %eax
     c6c:	68 da 41 00 00       	push   $0x41da
     c71:	6a 01                	push   $0x1
     c73:	e8 58 2e 00 00       	call   3ad0 <printf>
    return;
  ...
  close(pfds[0]);
     ...
     c89:	e8 15 2d 00 00       	call   39a3 <close>
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
     c90:	68 ed 41 00 00       	push   $0x41ed
     c95:	6a 01                	push   $0x1
     c97:	e8 34 2e 00 00       	call   3ad0 <printf>
  kill(pid1);
     c9c:	89 3c 24             	mov    %edi,(%esp)
     c9f:	e8 07 2d 00 00       	call   39ab <kill>
  kill(pid2);
     ca4:	89 34 24             	mov    %esi,(%esp)
     ca7:	e8 ff 2c 00 00       	call   39ab <kill>
  kill(pid3);
     cac:	89 1c 24             	mov    %ebx,(%esp)
     caf:	e8 f7 2c 00 00       	call   39ab <kill>
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
     cb6:	68 f6 41 00 00       	push   $0x41f6
     cbb:	6a 01                	push   $0x1
     cbd:	e8 0e 2e 00 00       	call   3ad0 <printf>
  wait();
     cc2:	e8 bc 2c 00 00       	call   3983 <wait>
  wait();
     cc7:	e8 b7 2c 00 00       	call   3983 <wait>
  wait();
     ccc:	e8 b2 2c 00 00       	call   3983 <wait>
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
     cd3:	68 ff 41 00 00       	push   $0x41ff
     cd8:	6a 01                	push   $0x1
     cda:	e8 f1 2d 00 00       	call   3ad0 <printf>
...
00000cf0 <exitwait>:
{
    ...
    if(pid){
     d00:	74 6f                	je     d71 <exitwait+0x81>
      if(wait() != pid){
     d02:	e8 7c 2c 00 00       	call   3983 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d10:	e8 5e 2c 00 00       	call   3973 <fork>
    if(pid < 0){
    ...
    if(pid < 0){
     ...
     d1e:	68 69 4d 00 00       	push   $0x4d69
     d23:	6a 01                	push   $0x1
     ...
     d3b:	68 0b 42 00 00       	push   $0x420b
     d40:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d70:	c3                   	ret    
      exit();
     d71:	e8 05 2c 00 00       	call   397b <exit>
...
00000d80 <mem>:
{
  ...
  printf(1, "mem test\n");
     d8b:	68 28 42 00 00       	push   $0x4228
     d90:	6a 01                	push   $0x1
     d92:	e8 39 2d 00 00       	call   3ad0 <printf>
  ppid = getpid();
     d97:	e8 5f 2c 00 00       	call   39fb <getpid>
     d9c:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     d9e:	e8 d0 2b 00 00       	call   3973 <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dbc:	e8 6f 2f 00 00       	call   3d30 <malloc>
    ...
    while(m1){
     ...
     dd8:	e8 c3 2e 00 00       	call   3ca0 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     dec:	e8 3f 2f 00 00       	call   3d30 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     dfb:	50                   	push   %eax
     dfc:	e8 9f 2e 00 00       	call   3ca0 <free>
    printf(1, "mem ok\n");
     e01:	58                   	pop    %eax
     e02:	5a                   	pop    %edx
     e03:	68 4c 42 00 00       	push   $0x424c
     e08:	6a 01                	push   $0x1
     e0a:	e8 c1 2c 00 00       	call   3ad0 <printf>
    exit();
     e0f:	e8 67 2b 00 00       	call   397b <exit>
     e14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e18:	83 ec 08             	sub    $0x8,%esp
     e1b:	68 32 42 00 00       	push   $0x4232
     e20:	6a 01                	push   $0x1
     e22:	e8 a9 2c 00 00       	call   3ad0 <printf>
      kill(ppid);
     e27:	89 34 24             	mov    %esi,(%esp)
     e2a:	e8 7c 2b 00 00       	call   39ab <kill>
      exit();
     e2f:	e8 47 2b 00 00       	call   397b <exit>
     ...
     e3e:	5d                   	pop    %ebp
    wait();
     e3f:	e9 3f 2b 00 00       	jmp    3983 <wait>
...
00000e50 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     e59:	68 54 42 00 00       	push   $0x4254
     e5e:	6a 01                	push   $0x1
     e60:	e8 6b 2c 00 00       	call   3ad0 <printf>
  unlink("sharedfd");
     e65:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     e6c:	e8 5a 2b 00 00       	call   39cb <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e71:	59                   	pop    %ecx
     e72:	5b                   	pop    %ebx
     e73:	68 02 02 00 00       	push   $0x202
     e78:	68 63 42 00 00       	push   $0x4263
     e7d:	e8 39 2b 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  pid = fork();
     e94:	e8 da 2a 00 00       	call   3973 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  if(pid == 0)
    ...
    wait();
     ef6:	e8 88 2a 00 00       	call   3983 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f06:	e8 98 2a 00 00       	call   39a3 <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 63 42 00 00       	push   $0x4263
     f14:	e8 a2 2a 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f3c:	e8 52 2a 00 00       	call   3993 <read>
  ...
  close(fd);
     ...
     f7c:	e8 22 2a 00 00       	call   39a3 <close>
  unlink("sharedfd");
     f81:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     f88:	e8 3e 2a 00 00       	call   39cb <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fa3:	68 6c 42 00 00       	push   $0x426c
     fa8:	6a 01                	push   $0x1
     faa:	e8 21 2b 00 00       	call   3ad0 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fc3:	68 28 4f 00 00       	push   $0x4f28
     fc8:	6a 01                	push   $0x1
     fca:	e8 01 2b 00 00       	call   3ad0 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fdd:	68 74 4f 00 00       	push   $0x4f74
     fe2:	6a 01                	push   $0x1
     fe4:	e8 e7 2a 00 00       	call   3ad0 <printf>
    return;
     ...
     ff3:	c3                   	ret    
    exit();
     ff4:	e8 82 29 00 00       	call   397b <exit>
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ff9:	53                   	push   %ebx
     ffa:	57                   	push   %edi
     ffb:	68 79 42 00 00       	push   $0x4279
    1000:	6a 01                	push   $0x1
    1002:	e8 c9 2a 00 00       	call   3ad0 <printf>
    exit();
    1007:	e8 6f 29 00 00       	call   397b <exit>
...
00001010 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1016:	be 8e 42 00 00       	mov    $0x428e,%esi
  for(pi = 0; pi < 4; pi++){
    101b:	31 db                	xor    %ebx,%ebx
{
    101d:	83 ec 34             	sub    $0x34,%esp
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 d8 8e 42 00 00 	movl   $0x428e,-0x28(%ebp)
    1027:	c7 45 dc d7 43 00 00 	movl   $0x43d7,-0x24(%ebp)
  printf(1, "fourfiles test\n");
    102e:	68 94 42 00 00       	push   $0x4294
    1033:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1035:	c7 45 e0 db 43 00 00 	movl   $0x43db,-0x20(%ebp)
    103c:	c7 45 e4 91 42 00 00 	movl   $0x4291,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    ...
    104e:	56                   	push   %esi
    104f:	e8 77 29 00 00       	call   39cb <unlink>
    pid = fork();
    1054:	e8 1a 29 00 00       	call   3973 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1078:	e8 06 29 00 00       	call   3983 <wait>
  for(i = 0; i < 2; i++){
    107d:	31 ff                	xor    %edi,%edi
    wait();
    107f:	e8 ff 28 00 00       	call   3983 <wait>
    1084:	e8 fa 28 00 00       	call   3983 <wait>
    1089:	e8 f5 28 00 00       	call   3983 <wait>
    108e:	c7 45 d0 8e 42 00 00 	movl   $0x428e,-0x30(%ebp)
    fd = open(fname, 0);
    ...
    109f:	e8 17 29 00 00       	call   39bb <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10c0:	e8 ce 28 00 00       	call   3993 <read>
    ...
    10ce:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10d0:	0f be b2 40 87 00 00 	movsbl 0x8740(%edx),%esi
    ...
    10f8:	e8 a6 28 00 00       	call   39a3 <close>
    if(total != 12*500){
    ...
    1112:	e8 b4 28 00 00       	call   39cb <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1122:	68 d2 42 00 00       	push   $0x42d2
    1127:	6a 01                	push   $0x1
    1129:	e8 a2 29 00 00       	call   3ad0 <printf>
}
    ...
    1151:	56                   	push   %esi
    1152:	e8 64 28 00 00       	call   39bb <open>
      if(fd < 0){
    ...
    1171:	68 40 87 00 00       	push   $0x8740
    ...
    1186:	68 40 87 00 00       	push   $0x8740
    118b:	56                   	push   %esi
    118c:	e8 0a 28 00 00       	call   399b <write>
    ...
    119e:	75 de                	jne    117e <fourfiles+0x16e>
      exit();
    11a0:	e8 d6 27 00 00       	call   397b <exit>
          printf(1, "wrong char\n");
    11a5:	83 ec 08             	sub    $0x8,%esp
    11a8:	68 b5 42 00 00       	push   $0x42b5
    11ad:	6a 01                	push   $0x1
    11af:	e8 1c 29 00 00       	call   3ad0 <printf>
          exit();
    11b4:	e8 c2 27 00 00       	call   397b <exit>
        printf(1, "create failed\n");
    11b9:	51                   	push   %ecx
    11ba:	51                   	push   %ecx
    11bb:	68 2f 45 00 00       	push   $0x452f
    11c0:	6a 01                	push   $0x1
    11c2:	e8 09 29 00 00       	call   3ad0 <printf>
        exit();
    11c7:	e8 af 27 00 00       	call   397b <exit>
      printf(1, "fork failed\n");
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    11ce:	68 69 4d 00 00       	push   $0x4d69
    11d3:	6a 01                	push   $0x1
    11d5:	e8 f6 28 00 00       	call   3ad0 <printf>
      exit();
    11da:	e8 9c 27 00 00       	call   397b <exit>
      printf(1, "wrong length %d\n", total);
    11df:	50                   	push   %eax
    11e0:	53                   	push   %ebx
    11e1:	68 c1 42 00 00       	push   $0x42c1
    11e6:	6a 01                	push   $0x1
    11e8:	e8 e3 28 00 00       	call   3ad0 <printf>
      exit();
    11ed:	e8 89 27 00 00       	call   397b <exit>
          printf(1, "write failed %d\n", n);
    11f2:	52                   	push   %edx
    11f3:	50                   	push   %eax
    11f4:	68 a4 42 00 00       	push   $0x42a4
    11f9:	6a 01                	push   $0x1
    11fb:	e8 d0 28 00 00       	call   3ad0 <printf>
          exit();
    1200:	e8 76 27 00 00       	call   397b <exit>
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    122a:	e8 44 27 00 00       	call   3973 <fork>
    if(pid < 0){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    wait();
    124d:	e8 31 27 00 00       	call   3983 <wait>
    1252:	e8 2c 27 00 00       	call   3983 <wait>
    1257:	e8 27 27 00 00       	call   3983 <wait>
    125c:	e8 22 27 00 00       	call   3983 <wait>
  name[0] = name[1] = name[2] = 0;
    ...
    1296:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1299:	e8 1d 27 00 00       	call   39bb <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12bf:	50                   	push   %eax
    12c0:	e8 de 26 00 00       	call   39a3 <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    12f8:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fb:	e8 cb 26 00 00       	call   39cb <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1319:	6a 01                	push   $0x1
    131b:	e8 b0 27 00 00       	call   3ad0 <printf>
}
    ...
    1374:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1377:	e8 3f 26 00 00       	call   39bb <open>
        if(fd < 0){
    ...
    1386:	50                   	push   %eax
    1387:	e8 17 26 00 00       	call   39a3 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13a3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13a6:	e8 20 26 00 00       	call   39cb <unlink>
    ...
    13b2:	52                   	push   %edx
    13b3:	52                   	push   %edx
    13b4:	68 e1 3e 00 00       	push   $0x3ee1
    13b9:	6a 01                	push   $0x1
    13bb:	e8 10 27 00 00       	call   3ad0 <printf>
            exit();
    13c0:	e8 b6 25 00 00       	call   397b <exit>
    13c5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    13c8:	e8 ae 25 00 00       	call   397b <exit>
        printf(1, "oops createdelete %s didn't exist\n", name);
    13cd:	83 ec 04             	sub    $0x4,%esp
    13d0:	57                   	push   %edi
    13d1:	68 a0 4f 00 00       	push   $0x4fa0
    13d6:	6a 01                	push   $0x1
    13d8:	e8 f3 26 00 00       	call   3ad0 <printf>
        exit();
    13dd:	e8 99 25 00 00       	call   397b <exit>
          printf(1, "create failed\n");
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    13e4:	68 2f 45 00 00       	push   $0x452f
    13e9:	6a 01                	push   $0x1
    13eb:	e8 e0 26 00 00       	call   3ad0 <printf>
          exit();
    13f0:	e8 86 25 00 00       	call   397b <exit>
      printf(1, "fork failed\n");
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    13f7:	68 69 4d 00 00       	push   $0x4d69
    13fc:	6a 01                	push   $0x1
    13fe:	e8 cd 26 00 00       	call   3ad0 <printf>
      exit();
    1403:	e8 73 25 00 00       	call   397b <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1410:	50                   	push   %eax
    1411:	57                   	push   %edi
    1412:	68 c4 4f 00 00       	push   $0x4fc4
    1417:	6a 01                	push   $0x1
    1419:	e8 b2 26 00 00       	call   3ad0 <printf>
        exit();
    141e:	e8 58 25 00 00       	call   397b <exit>
...
00001430 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1438:	68 04 43 00 00       	push   $0x4304
    143d:	6a 01                	push   $0x1
    143f:	e8 8c 26 00 00       	call   3ad0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1444:	5b                   	pop    %ebx
    1445:	5e                   	pop    %esi
    1446:	68 02 02 00 00       	push   $0x202
    144b:	68 15 43 00 00       	push   $0x4315
    1450:	e8 66 25 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    1465:	6a 05                	push   $0x5
    1467:	68 3a 43 00 00       	push   $0x433a
    146c:	50                   	push   %eax
    146d:	e8 29 25 00 00       	call   399b <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 29 25 00 00       	call   39a3 <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 15 43 00 00       	push   $0x4315
    1483:	e8 33 25 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    1498:	68 15 43 00 00       	push   $0x4315
    149d:	e8 29 25 00 00       	call   39cb <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14b5:	68 15 43 00 00       	push   $0x4315
    14ba:	e8 fc 24 00 00       	call   39bb <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    14c4:	6a 03                	push   $0x3
    14c6:	68 72 43 00 00       	push   $0x4372
    14cb:	50                   	push   %eax
    14cc:	e8 ca 24 00 00       	call   399b <write>
  close(fd1);
    14d1:	89 34 24             	mov    %esi,(%esp)
    14d4:	e8 ca 24 00 00       	call   39a3 <close>
  if(read(fd, buf, sizeof(buf)) != 5){
    14d9:	83 c4 0c             	add    $0xc,%esp
    14dc:	68 00 20 00 00       	push   $0x2000
    14e1:	68 40 87 00 00       	push   $0x8740
    14e6:	53                   	push   %ebx
    14e7:	e8 a7 24 00 00       	call   3993 <read>
    14ec:	83 c4 10             	add    $0x10,%esp
    14ef:	83 f8 05             	cmp    $0x5,%eax
    14f2:	0f 85 87 00 00 00    	jne    157f <unlinkread+0x14f>
  if(buf[0] != 'h'){
    14f8:	80 3d 40 87 00 00 68 	cmpb   $0x68,0x8740
    14ff:	75 6b                	jne    156c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1501:	83 ec 04             	sub    $0x4,%esp
    1504:	6a 0a                	push   $0xa
    1506:	68 40 87 00 00       	push   $0x8740
    150b:	53                   	push   %ebx
    150c:	e8 8a 24 00 00       	call   399b <write>
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 81 24 00 00       	call   39a3 <close>
  unlink("unlinkread");
    1522:	c7 04 24 15 43 00 00 	movl   $0x4315,(%esp)
    1529:	e8 9d 24 00 00       	call   39cb <unlink>
  printf(1, "unlinkread ok\n");
    152e:	58                   	pop    %eax
    152f:	5a                   	pop    %edx
    1530:	68 bd 43 00 00       	push   $0x43bd
    1535:	6a 01                	push   $0x1
    1537:	e8 94 25 00 00       	call   3ad0 <printf>
}
    ...
    1546:	51                   	push   %ecx
    1547:	51                   	push   %ecx
    1548:	68 20 43 00 00       	push   $0x4320
    154d:	6a 01                	push   $0x1
    154f:	e8 7c 25 00 00       	call   3ad0 <printf>
    exit();
    1554:	e8 22 24 00 00       	call   397b <exit>
    printf(1, "unlinkread write failed\n");
    1559:	51                   	push   %ecx
    155a:	51                   	push   %ecx
    155b:	68 a4 43 00 00       	push   $0x43a4
    1560:	6a 01                	push   $0x1
    1562:	e8 69 25 00 00       	call   3ad0 <printf>
    exit();
    1567:	e8 0f 24 00 00       	call   397b <exit>
    printf(1, "unlinkread wrong data\n");
    156c:	53                   	push   %ebx
    156d:	53                   	push   %ebx
    156e:	68 8d 43 00 00       	push   $0x438d
    1573:	6a 01                	push   $0x1
    1575:	e8 56 25 00 00       	call   3ad0 <printf>
    exit();
    157a:	e8 fc 23 00 00       	call   397b <exit>
    printf(1, "unlinkread read failed");
    157f:	56                   	push   %esi
    1580:	56                   	push   %esi
    1581:	68 76 43 00 00       	push   $0x4376
    1586:	6a 01                	push   $0x1
    1588:	e8 43 25 00 00       	call   3ad0 <printf>
    exit();
    158d:	e8 e9 23 00 00       	call   397b <exit>
    printf(1, "unlink unlinkread failed\n");
    1592:	50                   	push   %eax
    1593:	50                   	push   %eax
    1594:	68 58 43 00 00       	push   $0x4358
    1599:	6a 01                	push   $0x1
    159b:	e8 30 25 00 00       	call   3ad0 <printf>
    exit();
    15a0:	e8 d6 23 00 00       	call   397b <exit>
    printf(1, "open unlinkread failed\n");
    15a5:	50                   	push   %eax
    15a6:	50                   	push   %eax
    15a7:	68 40 43 00 00       	push   $0x4340
    15ac:	6a 01                	push   $0x1
    15ae:	e8 1d 25 00 00       	call   3ad0 <printf>
    exit();
    15b3:	e8 c3 23 00 00       	call   397b <exit>
    15b8:	90                   	nop
...
000015c0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15c7:	68 cc 43 00 00       	push   $0x43cc
    15cc:	6a 01                	push   $0x1
    15ce:	e8 fd 24 00 00       	call   3ad0 <printf>
  unlink("lf1");
    15d3:	c7 04 24 d6 43 00 00 	movl   $0x43d6,(%esp)
    15da:	e8 ec 23 00 00       	call   39cb <unlink>
  unlink("lf2");
    15df:	c7 04 24 da 43 00 00 	movl   $0x43da,(%esp)
    15e6:	e8 e0 23 00 00       	call   39cb <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15eb:	58                   	pop    %eax
    15ec:	5a                   	pop    %edx
    15ed:	68 02 02 00 00       	push   $0x202
    15f2:	68 d6 43 00 00       	push   $0x43d6
    15f7:	e8 bf 23 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    160c:	6a 05                	push   $0x5
    160e:	68 3a 43 00 00       	push   $0x433a
    1613:	50                   	push   %eax
    1614:	e8 82 23 00 00       	call   399b <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 75 23 00 00       	call   39a3 <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 da 43 00 00       	push   $0x43da
    1635:	68 d6 43 00 00       	push   $0x43d6
    163a:	e8 9c 23 00 00       	call   39db <link>
    163f:	83 c4 10             	add    $0x10,%esp
    1642:	85 c0                	test   %eax,%eax
    1644:	0f 88 60 01 00 00    	js     17aa <linktest+0x1ea>
  unlink("lf1");
    164a:	83 ec 0c             	sub    $0xc,%esp
    164d:	68 d6 43 00 00       	push   $0x43d6
    1652:	e8 74 23 00 00       	call   39cb <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 d6 43 00 00       	push   $0x43d6
    1660:	e8 56 23 00 00       	call   39bb <open>
  ...
  fd = open("lf2", 0);
    ...
    1673:	6a 00                	push   $0x0
    1675:	68 da 43 00 00       	push   $0x43da
    167a:	e8 3c 23 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 40 87 00 00       	push   $0x8740
    1699:	50                   	push   %eax
    169a:	e8 f4 22 00 00       	call   3993 <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 ef 22 00 00       	call   39a3 <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 da 43 00 00       	push   $0x43da
    16bb:	68 da 43 00 00       	push   $0x43da
    16c0:	e8 16 23 00 00       	call   39db <link>
    16c5:	83 c4 10             	add    $0x10,%esp
    16c8:	85 c0                	test   %eax,%eax
    16ca:	0f 89 8e 00 00 00    	jns    175e <linktest+0x19e>
  unlink("lf2");
    16d0:	83 ec 0c             	sub    $0xc,%esp
    16d3:	68 da 43 00 00       	push   $0x43da
    16d8:	e8 ee 22 00 00       	call   39cb <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 d6 43 00 00       	push   $0x43d6
    16e4:	68 da 43 00 00       	push   $0x43da
    16e9:	e8 ed 22 00 00       	call   39db <link>
    16ee:	83 c4 10             	add    $0x10,%esp
    16f1:	85 c0                	test   %eax,%eax
    16f3:	79 56                	jns    174b <linktest+0x18b>
  if(link(".", "lf1") >= 0){
    16f5:	83 ec 08             	sub    $0x8,%esp
    16f8:	68 d6 43 00 00       	push   $0x43d6
    16fd:	68 9e 46 00 00       	push   $0x469e
    1702:	e8 d4 22 00 00       	call   39db <link>
    1707:	83 c4 10             	add    $0x10,%esp
    170a:	85 c0                	test   %eax,%eax
    170c:	79 2a                	jns    1738 <linktest+0x178>
  printf(1, "linktest ok\n");
    170e:	83 ec 08             	sub    $0x8,%esp
    1711:	68 74 44 00 00       	push   $0x4474
    1716:	6a 01                	push   $0x1
    1718:	e8 b3 23 00 00       	call   3ad0 <printf>
}
    ...
    1725:	50                   	push   %eax
    1726:	50                   	push   %eax
    1727:	68 de 43 00 00       	push   $0x43de
    172c:	6a 01                	push   $0x1
    172e:	e8 9d 23 00 00       	call   3ad0 <printf>
    exit();
    1733:	e8 43 22 00 00       	call   397b <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1738:	50                   	push   %eax
    1739:	50                   	push   %eax
    173a:	68 58 44 00 00       	push   $0x4458
    173f:	6a 01                	push   $0x1
    1741:	e8 8a 23 00 00       	call   3ad0 <printf>
    exit();
    1746:	e8 30 22 00 00       	call   397b <exit>
    printf(1, "link non-existant succeeded! oops\n");
    174b:	52                   	push   %edx
    174c:	52                   	push   %edx
    174d:	68 0c 50 00 00       	push   $0x500c
    1752:	6a 01                	push   $0x1
    1754:	e8 77 23 00 00       	call   3ad0 <printf>
    exit();
    1759:	e8 1d 22 00 00       	call   397b <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    175e:	50                   	push   %eax
    175f:	50                   	push   %eax
    1760:	68 3a 44 00 00       	push   $0x443a
    1765:	6a 01                	push   $0x1
    1767:	e8 64 23 00 00       	call   3ad0 <printf>
    exit();
    176c:	e8 0a 22 00 00       	call   397b <exit>
    printf(1, "read lf2 failed\n");
    1771:	51                   	push   %ecx
    1772:	51                   	push   %ecx
    1773:	68 29 44 00 00       	push   $0x4429
    1778:	6a 01                	push   $0x1
    177a:	e8 51 23 00 00       	call   3ad0 <printf>
    exit();
    177f:	e8 f7 21 00 00       	call   397b <exit>
    printf(1, "open lf2 failed\n");
    1784:	53                   	push   %ebx
    1785:	53                   	push   %ebx
    1786:	68 18 44 00 00       	push   $0x4418
    178b:	6a 01                	push   $0x1
    178d:	e8 3e 23 00 00       	call   3ad0 <printf>
    exit();
    1792:	e8 e4 21 00 00       	call   397b <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1797:	50                   	push   %eax
    1798:	50                   	push   %eax
    1799:	68 e4 4f 00 00       	push   $0x4fe4
    179e:	6a 01                	push   $0x1
    17a0:	e8 2b 23 00 00       	call   3ad0 <printf>
    exit();
    17a5:	e8 d1 21 00 00       	call   397b <exit>
    printf(1, "link lf1 lf2 failed\n");
    17aa:	51                   	push   %ecx
    17ab:	51                   	push   %ecx
    17ac:	68 03 44 00 00       	push   $0x4403
    17b1:	6a 01                	push   $0x1
    17b3:	e8 18 23 00 00       	call   3ad0 <printf>
    exit();
    17b8:	e8 be 21 00 00       	call   397b <exit>
    printf(1, "write lf1 failed\n");
    17bd:	50                   	push   %eax
    17be:	50                   	push   %eax
    17bf:	68 f1 43 00 00       	push   $0x43f1
    17c4:	6a 01                	push   $0x1
    17c6:	e8 05 23 00 00       	call   3ad0 <printf>
    exit();
    17cb:	e8 ab 21 00 00       	call   397b <exit>
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  printf(1, "concreate test\n");
    17e3:	68 81 44 00 00       	push   $0x4481
    17e8:	6a 01                	push   $0x1
    17ea:	e8 e1 22 00 00       	call   3ad0 <printf>
  file[0] = 'C';
  ...
  file[2] = '\0';
    ...
    181e:	53                   	push   %ebx
    181f:	e8 97 21 00 00       	call   39bb <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    182e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1831:	50                   	push   %eax
    1832:	e8 6c 21 00 00       	call   39a3 <close>
    1837:	83 c4 10             	add    $0x10,%esp
      wait();
    183a:	e8 44 21 00 00       	call   3983 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1852:	e8 74 21 00 00       	call   39cb <unlink>
    pid = fork();
    1857:	e8 17 21 00 00       	call   3973 <fork>
    if(pid && (i % 3) == 1){
    ...
    1881:	53                   	push   %ebx
    1882:	e8 34 21 00 00       	call   39bb <open>
      if(fd < 0){
    ...
    1895:	53                   	push   %ebx
    1896:	68 94 44 00 00       	push   $0x4494
    189b:	6a 01                	push   $0x1
    189d:	e8 2e 22 00 00       	call   3ad0 <printf>
        exit();
    18a2:	e8 d4 20 00 00       	call   397b <exit>
    ...
    18b9:	e8 1d 21 00 00       	call   39db <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 b5 20 00 00       	call   397b <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 fa 20 00 00       	call   39db <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 9a 20 00 00       	call   3983 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 a8 20 00 00       	call   39bb <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 67 20 00 00       	call   3993 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 2a 20 00 00       	call   39a3 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 29 20 00 00       	call   39cb <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 21 20 00 00       	call   39cb <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 19 20 00 00       	call   39cb <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 11 20 00 00       	call   39cb <unlink>
  ...
  for(i = 0; i < 40; i++){
    19c5:	83 c6 01             	add    $0x1,%esi
      wait();
    19c8:	e8 b6 1f 00 00       	call   3983 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19d8:	e8 96 1f 00 00       	call   3973 <fork>
    if(pid < 0){
    ...
    1a00:	6a 00                	push   $0x0
    1a02:	53                   	push   %ebx
    1a03:	e8 b3 1f 00 00       	call   39bb <open>
    1a08:	89 04 24             	mov    %eax,(%esp)
    1a0b:	e8 93 1f 00 00       	call   39a3 <close>
      close(open(file, 0));
    1a10:	58                   	pop    %eax
    1a11:	5a                   	pop    %edx
    1a12:	6a 00                	push   $0x0
    1a14:	53                   	push   %ebx
    1a15:	e8 a1 1f 00 00       	call   39bb <open>
    1a1a:	89 04 24             	mov    %eax,(%esp)
    1a1d:	e8 81 1f 00 00       	call   39a3 <close>
      close(open(file, 0));
    1a22:	59                   	pop    %ecx
    1a23:	58                   	pop    %eax
    1a24:	6a 00                	push   $0x0
    1a26:	53                   	push   %ebx
    1a27:	e8 8f 1f 00 00       	call   39bb <open>
    1a2c:	89 04 24             	mov    %eax,(%esp)
    1a2f:	e8 6f 1f 00 00       	call   39a3 <close>
      close(open(file, 0));
    1a34:	58                   	pop    %eax
    1a35:	5a                   	pop    %edx
    1a36:	6a 00                	push   $0x0
    1a38:	53                   	push   %ebx
    1a39:	e8 7d 1f 00 00       	call   39bb <open>
    1a3e:	89 04 24             	mov    %eax,(%esp)
    1a41:	e8 5d 1f 00 00       	call   39a3 <close>
    1a46:	83 c4 10             	add    $0x10,%esp
    1a49:	e9 6f ff ff ff       	jmp    19bd <concreate+0x1ed>
    1a4e:	66 90                	xchg   %ax,%ax
  printf(1, "concreate ok\n");
    1a50:	83 ec 08             	sub    $0x8,%esp
    1a53:	68 e6 44 00 00       	push   $0x44e6
    1a58:	6a 01                	push   $0x1
    ...
    1a6a:	68 69 4d 00 00       	push   $0x4d69
    1a6f:	6a 01                	push   $0x1
    1a71:	e8 5a 20 00 00       	call   3ad0 <printf>
      exit();
    1a76:	e8 00 1f 00 00       	call   397b <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a7b:	51                   	push   %ecx
    1a7c:	51                   	push   %ecx
    1a7d:	68 30 50 00 00       	push   $0x5030
    1a82:	6a 01                	push   $0x1
    1a84:	e8 47 20 00 00       	call   3ad0 <printf>
    exit();
    1a89:	e8 ed 1e 00 00       	call   397b <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    1a8e:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1a91:	53                   	push   %ebx
    1a92:	50                   	push   %eax
    1a93:	68 c9 44 00 00       	push   $0x44c9
    1a98:	6a 01                	push   $0x1
    1a9a:	e8 31 20 00 00       	call   3ad0 <printf>
        exit();
    1a9f:	e8 d7 1e 00 00       	call   397b <exit>
        printf(1, "concreate weird file %s\n", de.name);
    1aa4:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1aa7:	56                   	push   %esi
    1aa8:	50                   	push   %eax
    1aa9:	68 b0 44 00 00       	push   $0x44b0
    1aae:	6a 01                	push   $0x1
    1ab0:	e8 1b 20 00 00       	call   3ad0 <printf>
        exit();
    1ab5:	e8 c1 1e 00 00       	call   397b <exit>
      close(fd);
    1aba:	83 ec 0c             	sub    $0xc,%esp
    1abd:	50                   	push   %eax
    1abe:	e8 e0 1e 00 00       	call   39a3 <close>
...
00001ad0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ad9:	68 f4 44 00 00       	push   $0x44f4
    1ade:	6a 01                	push   $0x1
    1ae0:	e8 eb 1f 00 00       	call   3ad0 <printf>
  unlink("x");
    1ae5:	c7 04 24 81 47 00 00 	movl   $0x4781,(%esp)
    1aec:	e8 da 1e 00 00       	call   39cb <unlink>
  pid = fork();
    1af1:	e8 7d 1e 00 00       	call   3973 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b28:	68 81 47 00 00       	push   $0x4781
    1b2d:	e8 99 1e 00 00       	call   39cb <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b5d:	68 81 47 00 00       	push   $0x4781
    1b62:	e8 54 1e 00 00       	call   39bb <open>
    1b67:	89 04 24             	mov    %eax,(%esp)
    1b6a:	e8 34 1e 00 00       	call   39a3 <close>
  ...
  if(pid)
    ...
    wait();
    1b7e:	e8 00 1e 00 00       	call   3983 <wait>
  printf(1, "linkunlink ok\n");
    1b83:	83 ec 08             	sub    $0x8,%esp
    1b86:	68 09 45 00 00       	push   $0x4509
    1b8b:	6a 01                	push   $0x1
    ...
    1ba3:	68 81 47 00 00       	push   $0x4781
    1ba8:	68 05 45 00 00       	push   $0x4505
    1bad:	e8 29 1e 00 00       	call   39db <link>
    1bb2:	83 c4 10             	add    $0x10,%esp
    1bb5:	e9 7b ff ff ff       	jmp    1b35 <linkunlink+0x65>
    printf(1, "fork failed\n");
    1bba:	52                   	push   %edx
    1bbb:	52                   	push   %edx
    1bbc:	68 69 4d 00 00       	push   $0x4d69
    1bc1:	6a 01                	push   $0x1
    1bc3:	e8 08 1f 00 00       	call   3ad0 <printf>
    exit();
    1bc8:	e8 ae 1d 00 00       	call   397b <exit>
    exit();
    1bcd:	e8 a9 1d 00 00       	call   397b <exit>
...
00001be0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1be9:	68 18 45 00 00       	push   $0x4518
    1bee:	6a 01                	push   $0x1
    1bf0:	e8 db 1e 00 00       	call   3ad0 <printf>
  unlink("bd");
    1bf5:	c7 04 24 25 45 00 00 	movl   $0x4525,(%esp)
    1bfc:	e8 ca 1d 00 00       	call   39cb <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 25 45 00 00       	push   $0x4525
    1c0d:	e8 a9 1d 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 78 1d 00 00       	call   39a3 <close>
    ...
    if(link("bd", name) != 0){
    1c3c:	57                   	push   %edi
    1c3d:	68 25 45 00 00       	push   $0x4525
    name[1] = '0' + (i / 64);
    ...
    if(link("bd", name) != 0){
    1c57:	e8 7f 1d 00 00       	call   39db <link>
  ...
  unlink("bd");
    ...
    1c73:	68 25 45 00 00       	push   $0x4525
    1c78:	e8 4e 1d 00 00       	call   39cb <unlink>
    ...
    if(unlink(name) != 0){
    1ca2:	e8 24 1d 00 00       	call   39cb <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cbc:	68 67 45 00 00       	push   $0x4567
    1cc1:	6a 01                	push   $0x1
    ...
    1cd6:	68 3e 45 00 00       	push   $0x453e
    1cdb:	6a 01                	push   $0x1
    1cdd:	e8 ee 1d 00 00       	call   3ad0 <printf>
      exit();
    1ce2:	e8 94 1c 00 00       	call   397b <exit>
      printf(1, "bigdir unlink failed");
    1ce7:	83 ec 08             	sub    $0x8,%esp
    1cea:	68 52 45 00 00       	push   $0x4552
    1cef:	6a 01                	push   $0x1
    1cf1:	e8 da 1d 00 00       	call   3ad0 <printf>
      exit();
    1cf6:	e8 80 1c 00 00       	call   397b <exit>
    printf(1, "bigdir create failed\n");
    1cfb:	50                   	push   %eax
    1cfc:	50                   	push   %eax
    1cfd:	68 28 45 00 00       	push   $0x4528
    1d02:	6a 01                	push   $0x1
    1d04:	e8 c7 1d 00 00       	call   3ad0 <printf>
    exit();
    1d09:	e8 6d 1c 00 00       	call   397b <exit>
...
00001d10 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d17:	68 72 45 00 00       	push   $0x4572
    1d1c:	6a 01                	push   $0x1
    1d1e:	e8 ad 1d 00 00       	call   3ad0 <printf>
  unlink("ff");
    1d23:	c7 04 24 fb 45 00 00 	movl   $0x45fb,(%esp)
    1d2a:	e8 9c 1c 00 00       	call   39cb <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d36:	e8 a8 1c 00 00       	call   39e3 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d4e:	68 d1 45 00 00       	push   $0x45d1
    1d53:	e8 63 1c 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d68:	6a 02                	push   $0x2
    1d6a:	68 fb 45 00 00       	push   $0x45fb
    1d6f:	50                   	push   %eax
    1d70:	e8 26 1c 00 00       	call   399b <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 26 1c 00 00       	call   39a3 <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d84:	e8 42 1c 00 00       	call   39cb <unlink>
    1d89:	83 c4 10             	add    $0x10,%esp
    1d8c:	85 c0                	test   %eax,%eax
    1d8e:	0f 89 3f 05 00 00    	jns    22d3 <subdir+0x5c3>
  if(mkdir("/dd/dd") != 0){
    1d94:	83 ec 0c             	sub    $0xc,%esp
    1d97:	68 ac 45 00 00       	push   $0x45ac
    1d9c:	e8 42 1c 00 00       	call   39e3 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db4:	68 ce 45 00 00       	push   $0x45ce
    1db9:	e8 fd 1b 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dce:	6a 02                	push   $0x2
    1dd0:	68 ef 45 00 00       	push   $0x45ef
    1dd5:	50                   	push   %eax
    1dd6:	e8 c0 1b 00 00       	call   399b <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 c0 1b 00 00       	call   39a3 <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 f2 45 00 00       	push   $0x45f2
    1dec:	e8 ca 1b 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e06:	68 40 87 00 00       	push   $0x8740
    1e0b:	50                   	push   %eax
    1e0c:	e8 82 1b 00 00       	call   3993 <read>
  if(cc != 2 || buf[0] != 'f'){
    1e11:	83 c4 10             	add    $0x10,%esp
    1e14:	83 f8 02             	cmp    $0x2,%eax
    1e17:	0f 85 3a 03 00 00    	jne    2157 <subdir+0x447>
    1e1d:	80 3d 40 87 00 00 66 	cmpb   $0x66,0x8740
    1e24:	0f 85 2d 03 00 00    	jne    2157 <subdir+0x447>
  close(fd);
    1e2a:	83 ec 0c             	sub    $0xc,%esp
    1e2d:	53                   	push   %ebx
    1e2e:	e8 70 1b 00 00       	call   39a3 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 32 46 00 00       	push   $0x4632
    1e3a:	68 ce 45 00 00       	push   $0x45ce
    1e3f:	e8 97 1b 00 00       	call   39db <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e52:	68 ce 45 00 00       	push   $0x45ce
    1e57:	e8 6f 1b 00 00       	call   39cb <unlink>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ee4:	6a 00                	push   $0x0
    1ee6:	68 32 46 00 00       	push   $0x4632
    1eeb:	e8 cb 1a 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 40 87 00 00       	push   $0x8740
    1f0a:	50                   	push   %eax
    1f0b:	e8 83 1a 00 00       	call   3993 <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 7e 1a 00 00       	call   39a3 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	59                   	pop    %ecx
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 ce 45 00 00       	push   $0x45ce
    1f2e:	e8 88 1a 00 00       	call   39bb <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f46:	68 e6 46 00 00       	push   $0x46e6
    1f4b:	e8 6b 1a 00 00       	call   39bb <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f63:	68 0b 47 00 00       	push   $0x470b
    1f68:	e8 4e 1a 00 00       	call   39bb <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f80:	68 98 46 00 00       	push   $0x4698
    1f85:	e8 31 1a 00 00       	call   39bb <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f98:	6a 02                	push   $0x2
    1f9a:	68 98 46 00 00       	push   $0x4698
    1f9f:	e8 17 1a 00 00       	call   39bb <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb2:	6a 01                	push   $0x1
    1fb4:	68 98 46 00 00       	push   $0x4698
    1fb9:	e8 fd 19 00 00       	call   39bb <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fcc:	68 7a 47 00 00       	push   $0x477a
    1fd1:	68 e6 46 00 00       	push   $0x46e6
    1fd6:	e8 00 1a 00 00       	call   39db <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fe9:	68 7a 47 00 00       	push   $0x477a
    1fee:	68 0b 47 00 00       	push   $0x470b
    1ff3:	e8 e3 19 00 00       	call   39db <link>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2053:	68 32 46 00 00       	push   $0x4632
    2058:	e8 86 19 00 00       	call   39e3 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    206b:	68 0b 47 00 00       	push   $0x470b
    2070:	e8 56 19 00 00       	call   39cb <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2157:	50                   	push   %eax
    2158:	50                   	push   %eax
    2159:	68 17 46 00 00       	push   $0x4617
    215e:	6a 01                	push   $0x1
    2160:	e8 6b 19 00 00       	call   3ad0 <printf>
    exit();
    2165:	e8 11 18 00 00       	call   397b <exit>
    printf(1, "chdir dd/../../dd failed\n");
    216a:	50                   	push   %eax
    216b:	50                   	push   %eax
    216c:	68 72 46 00 00       	push   $0x4672
    2171:	6a 01                	push   $0x1
    2173:	e8 58 19 00 00       	call   3ad0 <printf>
    exit();
    2178:	e8 fe 17 00 00       	call   397b <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    217d:	52                   	push   %edx
    217e:	52                   	push   %edx
    217f:	68 3d 46 00 00       	push   $0x463d
    2184:	6a 01                	push   $0x1
    2186:	e8 45 19 00 00       	call   3ad0 <printf>
    exit();
    218b:	e8 eb 17 00 00       	call   397b <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2190:	50                   	push   %eax
    2191:	50                   	push   %eax
    2192:	68 ef 46 00 00       	push   $0x46ef
    2197:	6a 01                	push   $0x1
    2199:	e8 32 19 00 00       	call   3ad0 <printf>
    exit();
    219e:	e8 d8 17 00 00       	call   397b <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21a3:	52                   	push   %edx
    21a4:	52                   	push   %edx
    21a5:	68 d4 50 00 00       	push   $0x50d4
    21aa:	6a 01                	push   $0x1
    21ac:	e8 1f 19 00 00       	call   3ad0 <printf>
    exit();
    21b1:	e8 c5 17 00 00       	call   397b <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21b6:	52                   	push   %edx
    21b7:	52                   	push   %edx
    21b8:	68 83 47 00 00       	push   $0x4783
    21bd:	6a 01                	push   $0x1
    21bf:	e8 0c 19 00 00       	call   3ad0 <printf>
    exit();
    21c4:	e8 b2 17 00 00       	call   397b <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21c9:	51                   	push   %ecx
    21ca:	51                   	push   %ecx
    21cb:	68 44 51 00 00       	push   $0x5144
    21d0:	6a 01                	push   $0x1
    21d2:	e8 f9 18 00 00       	call   3ad0 <printf>
    exit();
    21d7:	e8 9f 17 00 00       	call   397b <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21dc:	50                   	push   %eax
    21dd:	50                   	push   %eax
    21de:	68 fe 45 00 00       	push   $0x45fe
    21e3:	6a 01                	push   $0x1
    21e5:	e8 e6 18 00 00       	call   3ad0 <printf>
    exit();
    21ea:	e8 8c 17 00 00       	call   397b <exit>
    printf(1, "create dd/dd/ff failed\n");
    21ef:	51                   	push   %ecx
    21f0:	51                   	push   %ecx
    21f1:	68 d7 45 00 00       	push   $0x45d7
    21f6:	6a 01                	push   $0x1
    21f8:	e8 d3 18 00 00       	call   3ad0 <printf>
    exit();
    21fd:	e8 79 17 00 00       	call   397b <exit>
    printf(1, "chdir ./.. failed\n");
    2202:	50                   	push   %eax
    2203:	50                   	push   %eax
    2204:	68 a0 46 00 00       	push   $0x46a0
    2209:	6a 01                	push   $0x1
    220b:	e8 c0 18 00 00       	call   3ad0 <printf>
    exit();
    2210:	e8 66 17 00 00       	call   397b <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2215:	51                   	push   %ecx
    2216:	51                   	push   %ecx
    2217:	68 8c 50 00 00       	push   $0x508c
    221c:	6a 01                	push   $0x1
    221e:	e8 ad 18 00 00       	call   3ad0 <printf>
    exit();
    2223:	e8 53 17 00 00       	call   397b <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2228:	53                   	push   %ebx
    2229:	53                   	push   %ebx
    222a:	68 20 51 00 00       	push   $0x5120
    222f:	6a 01                	push   $0x1
    2231:	e8 9a 18 00 00       	call   3ad0 <printf>
    exit();
    2236:	e8 40 17 00 00       	call   397b <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    223b:	50                   	push   %eax
    223c:	50                   	push   %eax
    223d:	68 fc 50 00 00       	push   $0x50fc
    2242:	6a 01                	push   $0x1
    2244:	e8 87 18 00 00       	call   3ad0 <printf>
    exit();
    2249:	e8 2d 17 00 00       	call   397b <exit>
    printf(1, "open dd wronly succeeded!\n");
    224e:	50                   	push   %eax
    224f:	50                   	push   %eax
    2250:	68 5f 47 00 00       	push   $0x475f
    2255:	6a 01                	push   $0x1
    2257:	e8 74 18 00 00       	call   3ad0 <printf>
    exit();
    225c:	e8 1a 17 00 00       	call   397b <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2261:	50                   	push   %eax
    2262:	50                   	push   %eax
    2263:	68 46 47 00 00       	push   $0x4746
    2268:	6a 01                	push   $0x1
    226a:	e8 61 18 00 00       	call   3ad0 <printf>
    exit();
    226f:	e8 07 17 00 00       	call   397b <exit>
    printf(1, "create dd succeeded!\n");
    2274:	50                   	push   %eax
    2275:	50                   	push   %eax
    2276:	68 30 47 00 00       	push   $0x4730
    227b:	6a 01                	push   $0x1
    227d:	e8 4e 18 00 00       	call   3ad0 <printf>
    exit();
    2282:	e8 f4 16 00 00       	call   397b <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2287:	50                   	push   %eax
    2288:	50                   	push   %eax
    2289:	68 14 47 00 00       	push   $0x4714
    228e:	6a 01                	push   $0x1
    2290:	e8 3b 18 00 00       	call   3ad0 <printf>
    exit();
    2295:	e8 e1 16 00 00       	call   397b <exit>
    printf(1, "chdir dd failed\n");
    229a:	50                   	push   %eax
    229b:	50                   	push   %eax
    229c:	68 55 46 00 00       	push   $0x4655
    22a1:	6a 01                	push   $0x1
    22a3:	e8 28 18 00 00       	call   3ad0 <printf>
    exit();
    22a8:	e8 ce 16 00 00       	call   397b <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    22af:	68 b0 50 00 00       	push   $0x50b0
    22b4:	6a 01                	push   $0x1
    22b6:	e8 15 18 00 00       	call   3ad0 <printf>
    exit();
    22bb:	e8 bb 16 00 00       	call   397b <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22c0:	53                   	push   %ebx
    22c1:	53                   	push   %ebx
    22c2:	68 b3 45 00 00       	push   $0x45b3
    22c7:	6a 01                	push   $0x1
    22c9:	e8 02 18 00 00       	call   3ad0 <printf>
    exit();
    22ce:	e8 a8 16 00 00       	call   397b <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22d3:	50                   	push   %eax
    22d4:	50                   	push   %eax
    22d5:	68 64 50 00 00       	push   $0x5064
    22da:	6a 01                	push   $0x1
    22dc:	e8 ef 17 00 00       	call   3ad0 <printf>
    exit();
    22e1:	e8 95 16 00 00       	call   397b <exit>
    printf(1, "create dd/ff failed\n");
    22e6:	50                   	push   %eax
    22e7:	50                   	push   %eax
    22e8:	68 97 45 00 00       	push   $0x4597
    22ed:	6a 01                	push   $0x1
    22ef:	e8 dc 17 00 00       	call   3ad0 <printf>
    exit();
    22f4:	e8 82 16 00 00       	call   397b <exit>
    printf(1, "subdir mkdir dd failed\n");
    22f9:	50                   	push   %eax
    22fa:	50                   	push   %eax
    22fb:	68 7f 45 00 00       	push   $0x457f
    2300:	6a 01                	push   $0x1
    2302:	e8 c9 17 00 00       	call   3ad0 <printf>
    exit();
    2307:	e8 6f 16 00 00       	call   397b <exit>
    printf(1, "unlink dd failed\n");
    230c:	50                   	push   %eax
    230d:	50                   	push   %eax
    230e:	68 68 48 00 00       	push   $0x4868
    2313:	6a 01                	push   $0x1
    2315:	e8 b6 17 00 00       	call   3ad0 <printf>
    exit();
    231a:	e8 5c 16 00 00       	call   397b <exit>
    printf(1, "unlink dd/dd failed\n");
    231f:	52                   	push   %edx
    2320:	52                   	push   %edx
    2321:	68 53 48 00 00       	push   $0x4853
    2326:	6a 01                	push   $0x1
    2328:	e8 a3 17 00 00       	call   3ad0 <printf>
    exit();
    232d:	e8 49 16 00 00       	call   397b <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2332:	51                   	push   %ecx
    2333:	51                   	push   %ecx
    2334:	68 68 51 00 00       	push   $0x5168
    2339:	6a 01                	push   $0x1
    233b:	e8 90 17 00 00       	call   3ad0 <printf>
    exit();
    2340:	e8 36 16 00 00       	call   397b <exit>
    printf(1, "unlink dd/ff failed\n");
    2345:	53                   	push   %ebx
    2346:	53                   	push   %ebx
    2347:	68 3e 48 00 00       	push   $0x483e
    234c:	6a 01                	push   $0x1
    234e:	e8 7d 17 00 00       	call   3ad0 <printf>
    exit();
    2353:	e8 23 16 00 00       	call   397b <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2358:	50                   	push   %eax
    2359:	50                   	push   %eax
    235a:	68 26 48 00 00       	push   $0x4826
    235f:	6a 01                	push   $0x1
    2361:	e8 6a 17 00 00       	call   3ad0 <printf>
    exit();
    2366:	e8 10 16 00 00       	call   397b <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    236b:	50                   	push   %eax
    236c:	50                   	push   %eax
    236d:	68 0e 48 00 00       	push   $0x480e
    2372:	6a 01                	push   $0x1
    2374:	e8 57 17 00 00       	call   3ad0 <printf>
    exit();
    2379:	e8 fd 15 00 00       	call   397b <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    237e:	50                   	push   %eax
    237f:	50                   	push   %eax
    2380:	68 f2 47 00 00       	push   $0x47f2
    2385:	6a 01                	push   $0x1
    2387:	e8 44 17 00 00       	call   3ad0 <printf>
    exit();
    238c:	e8 ea 15 00 00       	call   397b <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2391:	50                   	push   %eax
    2392:	50                   	push   %eax
    2393:	68 d6 47 00 00       	push   $0x47d6
    2398:	6a 01                	push   $0x1
    239a:	e8 31 17 00 00       	call   3ad0 <printf>
    exit();
    239f:	e8 d7 15 00 00       	call   397b <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    23a4:	50                   	push   %eax
    23a5:	50                   	push   %eax
    23a6:	68 b9 47 00 00       	push   $0x47b9
    23ab:	6a 01                	push   $0x1
    23ad:	e8 1e 17 00 00       	call   3ad0 <printf>
    exit();
    23b2:	e8 c4 15 00 00       	call   397b <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23b7:	50                   	push   %eax
    23b8:	50                   	push   %eax
    23b9:	68 9e 47 00 00       	push   $0x479e
    23be:	6a 01                	push   $0x1
    23c0:	e8 0b 17 00 00       	call   3ad0 <printf>
    exit();
    23c5:	e8 b1 15 00 00       	call   397b <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23ca:	50                   	push   %eax
    23cb:	50                   	push   %eax
    23cc:	68 cb 46 00 00       	push   $0x46cb
    23d1:	6a 01                	push   $0x1
    23d3:	e8 f8 16 00 00       	call   3ad0 <printf>
    exit();
    23d8:	e8 9e 15 00 00       	call   397b <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23dd:	50                   	push   %eax
    23de:	50                   	push   %eax
    23df:	68 b3 46 00 00       	push   $0x46b3
    23e4:	6a 01                	push   $0x1
    23e6:	e8 e5 16 00 00       	call   3ad0 <printf>
    exit();
    23eb:	e8 8b 15 00 00       	call   397b <exit>
...
000023f0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23fd:	68 85 48 00 00       	push   $0x4885
    2402:	6a 01                	push   $0x1
    2404:	e8 c7 16 00 00       	call   3ad0 <printf>
  unlink("bigwrite");
    2409:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    2410:	e8 b6 15 00 00       	call   39cb <unlink>
    ...
    2428:	68 94 48 00 00       	push   $0x4894
    242d:	e8 89 15 00 00       	call   39bb <open>
    if(fd < 0){
    ...
    243e:	53                   	push   %ebx
    243f:	68 40 87 00 00       	push   $0x8740
    2444:	50                   	push   %eax
    2445:	e8 51 15 00 00       	call   399b <write>
      if(cc != sz){
    ...
    2454:	53                   	push   %ebx
    2455:	68 40 87 00 00       	push   $0x8740
    245a:	56                   	push   %esi
    245b:	e8 3b 15 00 00       	call   399b <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 2d 15 00 00       	call   39a3 <close>
    unlink("bigwrite");
    2476:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    247d:	e8 49 15 00 00       	call   39cb <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    2490:	68 c7 48 00 00       	push   $0x48c7
    2495:	6a 01                	push   $0x1
    ...
    24a6:	50                   	push   %eax
    24a7:	53                   	push   %ebx
    24a8:	68 b5 48 00 00       	push   $0x48b5
    24ad:	6a 01                	push   $0x1
    24af:	e8 1c 16 00 00       	call   3ad0 <printf>
        exit();
    24b4:	e8 c2 14 00 00       	call   397b <exit>
      printf(1, "cannot create bigwrite\n");
    24b9:	83 ec 08             	sub    $0x8,%esp
    24bc:	68 9d 48 00 00       	push   $0x489d
    24c1:	6a 01                	push   $0x1
    24c3:	e8 08 16 00 00       	call   3ad0 <printf>
      exit();
    24c8:	e8 ae 14 00 00       	call   397b <exit>
...
000024d0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    24d9:	68 d4 48 00 00       	push   $0x48d4
    24de:	6a 01                	push   $0x1
    24e0:	e8 eb 15 00 00       	call   3ad0 <printf>
  unlink("bigfile");
    24e5:	c7 04 24 f0 48 00 00 	movl   $0x48f0,(%esp)
    24ec:	e8 da 14 00 00       	call   39cb <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f1:	58                   	pop    %eax
    24f2:	5a                   	pop    %edx
    24f3:	68 02 02 00 00       	push   $0x202
    24f8:	68 f0 48 00 00       	push   $0x48f0
    24fd:	e8 b9 14 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2520:	53                   	push   %ebx
    2521:	68 40 87 00 00       	push   $0x8740
    2526:	e8 d5 11 00 00       	call   3700 <memset>
    if(write(fd, buf, 600) != 600){
    252b:	83 c4 0c             	add    $0xc,%esp
    252e:	68 58 02 00 00       	push   $0x258
    2533:	68 40 87 00 00       	push   $0x8740
    2538:	56                   	push   %esi
    2539:	e8 5d 14 00 00       	call   399b <write>
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 46 14 00 00       	call   39a3 <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 f0 48 00 00       	push   $0x48f0
    2566:	e8 50 14 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    258b:	0f be 05 40 87 00 00 	movsbl 0x8740,%eax
    2592:	89 fa                	mov    %edi,%edx
    2594:	d1 fa                	sar    %edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x138>
    259a:	0f be 15 6b 88 00 00 	movsbl 0x886b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 40 87 00 00       	push   $0x8740
    25bb:	56                   	push   %esi
    25bc:	e8 d2 13 00 00       	call   3993 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 d0 13 00 00       	call   39a3 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 dc 13 00 00       	call   39cb <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2612:	e8 b9 14 00 00       	call   3ad0 <printf>
      exit();
    2617:	e8 5f 13 00 00       	call   397b <exit>
    ...
    2626:	e8 a5 14 00 00       	call   3ad0 <printf>
      exit();
    262b:	e8 4b 13 00 00       	call   397b <exit>
    ...
    263a:	e8 91 14 00 00       	call   3ad0 <printf>
      exit();
    263f:	e8 37 13 00 00       	call   397b <exit>
    ...
    264e:	e8 7d 14 00 00       	call   3ad0 <printf>
      exit();
    2653:	e8 23 13 00 00       	call   397b <exit>
    printf(1, "cannot open bigfile\n");
    2658:	53                   	push   %ebx
    2659:	53                   	push   %ebx
    265a:	68 0e 49 00 00       	push   $0x490e
    265f:	6a 01                	push   $0x1
    2661:	e8 6a 14 00 00       	call   3ad0 <printf>
    exit();
    2666:	e8 10 13 00 00       	call   397b <exit>
    printf(1, "cannot create bigfile");
    266b:	50                   	push   %eax
    266c:	50                   	push   %eax
    266d:	68 e2 48 00 00       	push   $0x48e2
    2672:	6a 01                	push   $0x1
    2674:	e8 57 14 00 00       	call   3ad0 <printf>
    exit();
    2679:	e8 fd 12 00 00       	call   397b <exit>
    printf(1, "read bigfile wrong total\n");
    267e:	51                   	push   %ecx
    267f:	51                   	push   %ecx
    2680:	68 65 49 00 00       	push   $0x4965
    2685:	6a 01                	push   $0x1
    2687:	e8 44 14 00 00       	call   3ad0 <printf>
    exit();
    268c:	e8 ea 12 00 00       	call   397b <exit>
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26b9:	e8 25 13 00 00       	call   39e3 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26cc:	68 88 51 00 00       	push   $0x5188
    26d1:	e8 0d 13 00 00       	call   39e3 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26e9:	68 d8 51 00 00       	push   $0x51d8
    26ee:	e8 c8 12 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 9c 12 00 00       	call   39a3 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 48 52 00 00       	push   $0x5248
    2710:	e8 a6 12 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    276e:	e8 08 12 00 00       	call   397b <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 04 53 00 00       	push   $0x5304
    277a:	6a 01                	push   $0x1
    277c:	e8 4f 13 00 00       	call   3ad0 <printf>
    exit();
    2781:	e8 f5 11 00 00       	call   397b <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 b4 52 00 00       	push   $0x52b4
    278d:	6a 01                	push   $0x1
    278f:	e8 3c 13 00 00       	call   3ad0 <printf>
    exit();
    2794:	e8 e2 11 00 00       	call   397b <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 78 52 00 00       	push   $0x5278
    27a0:	6a 01                	push   $0x1
    27a2:	e8 29 13 00 00       	call   3ad0 <printf>
    exit();
    27a7:	e8 cf 11 00 00       	call   397b <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 08 52 00 00       	push   $0x5208
    27b3:	6a 01                	push   $0x1
    27b5:	e8 16 13 00 00       	call   3ad0 <printf>
    exit();
    27ba:	e8 bc 11 00 00       	call   397b <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 a8 51 00 00       	push   $0x51a8
    27c6:	6a 01                	push   $0x1
    27c8:	e8 03 13 00 00       	call   3ad0 <printf>
    exit();
    27cd:	e8 a9 11 00 00       	call   397b <exit>
...
000027e0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    27f9:	e8 e5 11 00 00       	call   39e3 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 d5 11 00 00       	call   39eb <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 9d 11 00 00       	call   39cb <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 85 11 00 00       	call   39cb <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 8d 11 00 00       	call   39eb <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 55 11 00 00       	call   39cb <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 41 11 00 00       	call   39cb <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 2d 11 00 00       	call   39cb <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28c7:	e8 af 10 00 00       	call   397b <exit>
    ...
    exit();
    28da:	e8 9c 10 00 00       	call   397b <exit>
    ...
    exit();
    28ed:	e8 89 10 00 00       	call   397b <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    ...
    exit();
    2900:	e8 76 10 00 00       	call   397b <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    ...
    exit();
    2913:	e8 63 10 00 00       	call   397b <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    ...
    exit();
    2926:	e8 50 10 00 00       	call   397b <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    ...
    exit();
    2939:	e8 3d 10 00 00       	call   397b <exit>
    ...
    exit();
    294c:	e8 2a 10 00 00       	call   397b <exit>
...
00002960 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297f:	e8 37 10 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 0b 10 00 00       	call   39a3 <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 a5 4a 00 00 	movl   $0x4aa5,(%esp)
    299f:	e8 47 10 00 00       	call   39eb <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 fd 0f 00 00       	call   39bb <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 e0 0f 00 00       	call   39bb <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 f0 0f 00 00       	call   39e3 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 c0 0f 00 00       	call   39cb <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 b3 0f 00 00       	call   39db <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 8b 0f 00 00       	call   39cb <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 61 0f 00 00       	call   39bb <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 47 0f 00 00       	call   39bb <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 15 0f 00 00       	call   399b <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 0d 0f 00 00       	call   39a3 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aba:	e8 bc 0e 00 00       	call   397b <exit>
    ...
    exit();
    2acd:	e8 a9 0e 00 00       	call   397b <exit>
    ...
    exit();
    2ae0:	e8 96 0e 00 00       	call   397b <exit>
    ...
    exit();
    2af3:	e8 83 0e 00 00       	call   397b <exit>
    printf(1, "open . for writing succeeded!\n");
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 58 53 00 00       	push   $0x5358
    2aff:	6a 01                	push   $0x1
    2b01:	e8 ca 0f 00 00       	call   3ad0 <printf>
    exit();
    2b06:	e8 70 0e 00 00       	call   397b <exit>
    ...
    exit();
    2b19:	e8 5d 0e 00 00       	call   397b <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 38 53 00 00       	push   $0x5338
    2b25:	6a 01                	push   $0x1
    2b27:	e8 a4 0f 00 00       	call   3ad0 <printf>
    exit();
    2b2c:	e8 4a 0e 00 00       	call   397b <exit>
    ...
    exit();
    2b3f:	e8 37 0e 00 00       	call   397b <exit>
    ...
    exit();
    2b52:	e8 24 0e 00 00       	call   397b <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b88:	e8 56 0e 00 00       	call   39e3 <mkdir>
    ...
    2ba0:	e8 46 0e 00 00       	call   39eb <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 ae 0d 00 00       	call   39eb <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c5d:	e8 6e 0e 00 00       	call   3ad0 <printf>
      exit();
    2c62:	e8 14 0d 00 00       	call   397b <exit>
    ...
    2c71:	e8 5a 0e 00 00       	call   3ad0 <printf>
      exit();
    2c76:	e8 00 0d 00 00       	call   397b <exit>
    2c7b:	90                   	nop
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 c1 0c 00 00       	call   3973 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 be 0c 00 00       	call   3983 <wait>
  ...
  if(wait() != -1){
    2cce:	e8 b0 0c 00 00       	call   3983 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cf3:	68 78 53 00 00       	push   $0x5378
    2cf8:	6a 01                	push   $0x1
    2cfa:	e8 d1 0d 00 00       	call   3ad0 <printf>
    exit();
    2cff:	e8 77 0c 00 00       	call   397b <exit>
      exit();
    2d04:	e8 72 0c 00 00       	call   397b <exit>
      printf(1, "wait stopped early\n");
    2d09:	83 ec 08             	sub    $0x8,%esp
    2d0c:	68 e3 4b 00 00       	push   $0x4be3
    2d11:	6a 01                	push   $0x1
    2d13:	e8 b8 0d 00 00       	call   3ad0 <printf>
      exit();
    2d18:	e8 5e 0c 00 00       	call   397b <exit>
    printf(1, "wait got too many\n");
    2d1d:	50                   	push   %eax
    2d1e:	50                   	push   %eax
    2d1f:	68 f7 4b 00 00       	push   $0x4bf7
    2d24:	6a 01                	push   $0x1
    2d26:	e8 a5 0d 00 00       	call   3ad0 <printf>
    exit();
    2d2b:	e8 4b 0c 00 00       	call   397b <exit>
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 54 5f 00 00    	pushl  0x5f54
    2d46:	e8 85 0d 00 00       	call   3ad0 <printf>
  oldbrk = sbrk(0);
    2d4b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d52:	e8 ac 0c 00 00       	call   3a03 <sbrk>
  a = sbrk(0);
    2d57:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d5e:	89 c3                	mov    %eax,%ebx
  a = sbrk(0);
    2d60:	e8 9e 0c 00 00       	call   3a03 <sbrk>
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 87 0c 00 00       	call   3a03 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 d6 0b 00 00       	call   3973 <fork>
  if(pid < 0){
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 4f 0c 00 00       	call   3a03 <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 43 0c 00 00       	call   3a03 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 ab 0b 00 00       	call   3983 <wait>
  a = sbrk(0);
    2dd8:	83 ec 0c             	sub    $0xc,%esp
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 21 0c 00 00       	call   3a03 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 10 0c 00 00       	call   3a03 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 f4 0b 00 00       	call   3a03 <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e18:	e8 e6 0b 00 00       	call   3a03 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 d0 0b 00 00       	call   3a03 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 b5 0b 00 00       	call   3a03 <sbrk>
    2e4e:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e50:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e57:	e8 a7 0b 00 00       	call   3a03 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 90 0b 00 00       	call   3a03 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 31 0b 00 00       	call   39fb <getpid>
    2eca:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ecc:	e8 a2 0a 00 00       	call   3973 <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    2ee5:	e8 99 0a 00 00       	call   3983 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2ef8:	50                   	push   %eax
    2ef9:	e8 8d 0a 00 00       	call   398b <pipe>
    ...
    2f21:	e8 6d 0a 00 00       	call   3993 <read>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2f33:	e8 3b 0a 00 00       	call   3973 <fork>
  ...
  c = sbrk(4096);
    ...
    2f9f:	50                   	push   %eax
    2fa0:	e8 06 0a 00 00       	call   39ab <kill>
    wait();
    2fa5:	e8 d9 09 00 00       	call   3983 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 3f 0a 00 00       	call   3a03 <sbrk>
    2fc4:	83 c4 10             	add    $0x10,%esp
    2fc7:	39 d8                	cmp    %ebx,%eax
    2fc9:	77 3c                	ja     3007 <sbrktest+0x2d7>
  printf(stdout, "sbrk test OK\n");
    2fcb:	83 ec 08             	sub    $0x8,%esp
    2fce:	68 c0 4c 00 00       	push   $0x4cc0
    2fd3:	ff 35 54 5f 00 00    	pushl  0x5f54
    2fd9:	e8 f2 0a 00 00       	call   3ad0 <printf>
}
    ...
    2fed:	56                   	push   %esi
    2fee:	57                   	push   %edi
    2fef:	68 23 4c 00 00       	push   $0x4c23
    2ff4:	ff 35 54 5f 00 00    	pushl  0x5f54
    2ffa:	e8 d1 0a 00 00       	call   3ad0 <printf>
      exit();
    2fff:	83 c4 20             	add    $0x20,%esp
    3002:	e8 74 09 00 00       	call   397b <exit>
    sbrk(-(sbrk(0) - oldbrk));
    3007:	83 ec 0c             	sub    $0xc,%esp
    300a:	6a 00                	push   $0x0
    300c:	e8 f2 09 00 00       	call   3a03 <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 e8 09 00 00       	call   3a03 <sbrk>
    301b:	83 c4 10             	add    $0x10,%esp
    301e:	eb ab                	jmp    2fcb <sbrktest+0x29b>
    printf(stdout, "failed sbrk leaked memory\n");
    3020:	50                   	push   %eax
    3021:	50                   	push   %eax
    3022:	68 a5 4c 00 00       	push   $0x4ca5
    3027:	ff 35 54 5f 00 00    	pushl  0x5f54
    302d:	e8 9e 0a 00 00       	call   3ad0 <printf>
    exit();
    3032:	e8 44 09 00 00       	call   397b <exit>
    printf(1, "pipe() failed\n");
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
    3039:	68 61 41 00 00       	push   $0x4161
    303e:	6a 01                	push   $0x1
    3040:	e8 8b 0a 00 00       	call   3ad0 <printf>
    exit();
    3045:	e8 31 09 00 00       	call   397b <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    304a:	0f be 06             	movsbl (%esi),%eax
    304d:	50                   	push   %eax
    304e:	56                   	push   %esi
    304f:	68 8c 4c 00 00       	push   $0x4c8c
    3054:	ff 35 54 5f 00 00    	pushl  0x5f54
    305a:	e8 71 0a 00 00       	call   3ad0 <printf>
      kill(ppid);
    305f:	89 3c 24             	mov    %edi,(%esp)
    3062:	e8 44 09 00 00       	call   39ab <kill>
      exit();
    3067:	e8 0f 09 00 00       	call   397b <exit>
      printf(stdout, "fork failed\n");
    306c:	51                   	push   %ecx
    306d:	51                   	push   %ecx
    306e:	68 69 4d 00 00       	push   $0x4d69
    3073:	ff 35 54 5f 00 00    	pushl  0x5f54
    3079:	e8 52 0a 00 00       	call   3ad0 <printf>
      exit();
    307e:	e8 f8 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    3083:	50                   	push   %eax
    3084:	56                   	push   %esi
    3085:	68 6c 54 00 00       	push   $0x546c
    308a:	ff 35 54 5f 00 00    	pushl  0x5f54
    3090:	e8 3b 0a 00 00       	call   3ad0 <printf>
    exit();
    3095:	e8 e1 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    309a:	53                   	push   %ebx
    309b:	53                   	push   %ebx
    309c:	68 3c 54 00 00       	push   $0x543c
    30a1:	ff 35 54 5f 00 00    	pushl  0x5f54
    30a7:	e8 24 0a 00 00       	call   3ad0 <printf>
    exit();
    30ac:	e8 ca 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    30b1:	57                   	push   %edi
    30b2:	56                   	push   %esi
    30b3:	68 14 54 00 00       	push   $0x5414
    30b8:	ff 35 54 5f 00 00    	pushl  0x5f54
    30be:	e8 0d 0a 00 00       	call   3ad0 <printf>
    exit();
    30c3:	e8 b3 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    30c8:	50                   	push   %eax
    30c9:	56                   	push   %esi
    30ca:	68 dc 53 00 00       	push   $0x53dc
    30cf:	ff 35 54 5f 00 00    	pushl  0x5f54
    30d5:	e8 f6 09 00 00       	call   3ad0 <printf>
    exit();
    30da:	e8 9c 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk could not deallocate\n");
    30df:	56                   	push   %esi
    30e0:	56                   	push   %esi
    30e1:	68 71 4c 00 00       	push   $0x4c71
    30e6:	ff 35 54 5f 00 00    	pushl  0x5f54
    30ec:	e8 df 09 00 00       	call   3ad0 <printf>
    exit();
    30f1:	e8 85 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30f6:	57                   	push   %edi
    30f7:	57                   	push   %edi
    30f8:	68 9c 53 00 00       	push   $0x539c
    30fd:	ff 35 54 5f 00 00    	pushl  0x5f54
    3103:	e8 c8 09 00 00       	call   3ad0 <printf>
    exit();
    3108:	e8 6e 08 00 00       	call   397b <exit>
    exit();
    310d:	e8 69 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3112:	50                   	push   %eax
    3113:	50                   	push   %eax
    3114:	68 55 4c 00 00       	push   $0x4c55
    3119:	ff 35 54 5f 00 00    	pushl  0x5f54
    311f:	e8 ac 09 00 00       	call   3ad0 <printf>
    exit();
    3124:	e8 52 08 00 00       	call   397b <exit>
    printf(stdout, "sbrk test fork failed\n");
    3129:	50                   	push   %eax
    312a:	50                   	push   %eax
    312b:	68 3e 4c 00 00       	push   $0x4c3e
    3130:	ff 35 54 5f 00 00    	pushl  0x5f54
    3136:	e8 95 09 00 00       	call   3ad0 <printf>
    exit();
    313b:	e8 3b 08 00 00       	call   397b <exit>
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    315a:	68 ce 4c 00 00       	push   $0x4cce
    315f:	ff 35 54 5f 00 00    	pushl  0x5f54
    3165:	e8 66 09 00 00       	call   3ad0 <printf>
    316a:	83 c4 10             	add    $0x10,%esp
    316d:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    3170:	e8 fe 07 00 00       	call   3973 <fork>
    ...
    317e:	6a 00                	push   $0x0
    3180:	e8 86 08 00 00       	call   3a0b <sleep>
    sleep(0);
    3185:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    318c:	e8 7a 08 00 00       	call   3a0b <sleep>
    kill(pid);
    3191:	89 34 24             	mov    %esi,(%esp)
    3194:	e8 12 08 00 00       	call   39ab <kill>
    wait();
    3199:	e8 e5 07 00 00       	call   3983 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    319e:	58                   	pop    %eax
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 dd 4c 00 00       	push   $0x4cdd
    31a6:	e8 30 08 00 00       	call   39db <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31c4:	68 01 4d 00 00       	push   $0x4d01
    31c9:	ff 35 54 5f 00 00    	pushl  0x5f54
    31cf:	e8 fc 08 00 00       	call   3ad0 <printf>
}
    ...
    31dd:	c3                   	ret    
      exit();
    31de:	e8 98 07 00 00       	call   397b <exit>
      printf(stdout, "link should not succeed\n");
    31e3:	83 ec 08             	sub    $0x8,%esp
    31e6:	68 e8 4c 00 00       	push   $0x4ce8
    31eb:	ff 35 54 5f 00 00    	pushl  0x5f54
    31f1:	e8 da 08 00 00       	call   3ad0 <printf>
      exit();
    31f6:	e8 80 07 00 00       	call   397b <exit>
    31fb:	90                   	nop
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3206:	68 0e 4d 00 00       	push   $0x4d0e
    320b:	ff 35 54 5f 00 00    	pushl  0x5f54
    3211:	e8 ba 08 00 00       	call   3ad0 <printf>
    if(uninit[i] != '\0'){
    3216:	83 c4 10             	add    $0x10,%esp
    3219:	80 3d 20 60 00 00 00 	cmpb   $0x0,0x6020
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3230:	80 b8 20 60 00 00 00 	cmpb   $0x0,0x6020(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3246:	68 29 4d 00 00       	push   $0x4d29
    ...
    325e:	68 18 4d 00 00       	push   $0x4d18
    3263:	ff 35 54 5f 00 00    	pushl  0x5f54
    3269:	e8 62 08 00 00       	call   3ad0 <printf>
      exit();
    326e:	e8 08 07 00 00       	call   397b <exit>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3286:	68 36 4d 00 00       	push   $0x4d36
    328b:	e8 3b 07 00 00       	call   39cb <unlink>
  pid = fork();
    3290:	e8 de 06 00 00       	call   3973 <fork>
  if(pid == 0){
  ...
  wait();
    32a2:	e8 dc 06 00 00       	call   3983 <wait>
  fd = open("bigarg-ok", 0);
    32a7:	83 ec 08             	sub    $0x8,%esp
    32aa:	6a 00                	push   $0x0
    32ac:	68 36 4d 00 00       	push   $0x4d36
    32b1:	e8 05 07 00 00       	call   39bb <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 d9 06 00 00       	call   39a3 <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 36 4d 00 00 	movl   $0x4d36,(%esp)
    32d1:	e8 f5 06 00 00       	call   39cb <unlink>
}
    32d6:	83 c4 10             	add    $0x10,%esp
    32d9:	c9                   	leave  
    32da:	c3                   	ret    
    32db:	b8 80 5f 00 00       	mov    $0x5f80,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32e0:	c7 00 90 54 00 00    	movl   $0x5490,(%eax)
    32e6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32e9:	3d fc 5f 00 00       	cmp    $0x5ffc,%eax
    32ee:	75 f0                	jne    32e0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    32f0:	51                   	push   %ecx
    32f1:	51                   	push   %ecx
    32f2:	68 40 4d 00 00       	push   $0x4d40
    32f7:	ff 35 54 5f 00 00    	pushl  0x5f54
    args[MAXARG-1] = 0;
    32fd:	c7 05 fc 5f 00 00 00 	movl   $0x0,0x5ffc
    3304:	00 00 00 
    printf(stdout, "bigarg test\n");
    3307:	e8 c4 07 00 00       	call   3ad0 <printf>
    exec("echo", args);
    330c:	58                   	pop    %eax
    330d:	5a                   	pop    %edx
    330e:	68 80 5f 00 00       	push   $0x5f80
    3313:	68 0d 3f 00 00       	push   $0x3f0d
    3318:	e8 96 06 00 00       	call   39b3 <exec>
    printf(stdout, "bigarg test ok\n");
    331d:	59                   	pop    %ecx
    331e:	58                   	pop    %eax
    331f:	68 4d 4d 00 00       	push   $0x4d4d
    3324:	ff 35 54 5f 00 00    	pushl  0x5f54
    332a:	e8 a1 07 00 00       	call   3ad0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    332f:	58                   	pop    %eax
    3330:	5a                   	pop    %edx
    3331:	68 00 02 00 00       	push   $0x200
    3336:	68 36 4d 00 00       	push   $0x4d36
    333b:	e8 7b 06 00 00       	call   39bb <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 5b 06 00 00       	call   39a3 <close>
    exit();
    3348:	e8 2e 06 00 00       	call   397b <exit>
    printf(stdout, "bigarg test failed!\n");
    334d:	50                   	push   %eax
    334e:	50                   	push   %eax
    334f:	68 76 4d 00 00       	push   $0x4d76
    3354:	ff 35 54 5f 00 00    	pushl  0x5f54
    335a:	e8 71 07 00 00       	call   3ad0 <printf>
    exit();
    335f:	e8 17 06 00 00       	call   397b <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3364:	52                   	push   %edx
    3365:	52                   	push   %edx
    3366:	68 5d 4d 00 00       	push   $0x4d5d
    336b:	ff 35 54 5f 00 00    	pushl  0x5f54
    3371:	e8 5a 07 00 00       	call   3ad0 <printf>
    exit();
    3376:	e8 00 06 00 00       	call   397b <exit>
    337b:	90                   	nop
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    338b:	68 8b 4d 00 00       	push   $0x4d8b
    3390:	6a 01                	push   $0x1
    3392:	e8 39 07 00 00       	call   3ad0 <printf>
    ...
    3413:	50                   	push   %eax
    3414:	68 98 4d 00 00       	push   $0x4d98
    3419:	6a 01                	push   $0x1
    341b:	e8 b0 06 00 00       	call   3ad0 <printf>
    ...
    342a:	50                   	push   %eax
    342b:	e8 8b 05 00 00       	call   39bb <open>
    if(fd < 0){
    ...
    344a:	68 40 87 00 00       	push   $0x8740
    344f:	57                   	push   %edi
    3450:	e8 46 05 00 00       	call   399b <write>
      if(cc < 512)
    ...
    3462:	56                   	push   %esi
    3463:	68 b4 4d 00 00       	push   $0x4db4
    3468:	6a 01                	push   $0x1
    346a:	e8 61 06 00 00       	call   3ad0 <printf>
    close(fd);
    346f:	89 3c 24             	mov    %edi,(%esp)
    3472:	e8 2c 05 00 00       	call   39a3 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3496:	50                   	push   %eax
    3497:	68 a4 4d 00 00       	push   $0x4da4
    349c:	6a 01                	push   $0x1
    349e:	e8 2d 06 00 00       	call   3ad0 <printf>
      break;
    ...
    3519:	50                   	push   %eax
    351a:	e8 ac 04 00 00       	call   39cb <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    352a:	68 c4 4d 00 00       	push   $0x4dc4
    352f:	6a 01                	push   $0x1
    3531:	e8 9a 05 00 00       	call   3ad0 <printf>
}
...
00003550 <uio>:
{
  ...
  printf(1, "uio test\n");
    3556:	68 da 4d 00 00       	push   $0x4dda
    355b:	6a 01                	push   $0x1
    355d:	e8 6e 05 00 00       	call   3ad0 <printf>
  pid = fork();
    3562:	e8 0c 04 00 00       	call   3973 <fork>
  if(pid == 0){
  ...
  wait();
    3570:	e8 0e 04 00 00       	call   3983 <wait>
  printf(1, "uio test done\n");
    3575:	83 ec 08             	sub    $0x8,%esp
    3578:	68 e4 4d 00 00       	push   $0x4de4
    357d:	6a 01                	push   $0x1
    ...
    359a:	52                   	push   %edx
    359b:	52                   	push   %edx
    359c:	68 70 55 00 00       	push   $0x5570
    35a1:	6a 01                	push   $0x1
    35a3:	e8 28 05 00 00       	call   3ad0 <printf>
    exit();
    35a8:	e8 ce 03 00 00       	call   397b <exit>
    printf (1, "fork failed\n");
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    35af:	68 69 4d 00 00       	push   $0x4d69
    35b4:	6a 01                	push   $0x1
    35b6:	e8 15 05 00 00       	call   3ad0 <printf>
    exit();
    35bb:	e8 bb 03 00 00       	call   397b <exit>
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35c7:	6a 00                	push   $0x0
    35c9:	68 f3 4d 00 00       	push   $0x4df3
    35ce:	e8 e8 03 00 00       	call   39bb <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 1d 04 00 00       	call   3a03 <sbrk>
    35e6:	83 c4 0c             	add    $0xc,%esp
    35e9:	83 e8 01             	sub    $0x1,%eax
    35ec:	6a ff                	push   $0xffffffff
    35ee:	50                   	push   %eax
    35ef:	53                   	push   %ebx
    35f0:	e8 9e 03 00 00       	call   3993 <read>
  close(fd);
    35f5:	89 1c 24             	mov    %ebx,(%esp)
    35f8:	e8 a6 03 00 00       	call   39a3 <close>
  printf(1, "arg test passed\n");
    35fd:	58                   	pop    %eax
    35fe:	5a                   	pop    %edx
    35ff:	68 05 4e 00 00       	push   $0x4e05
    3604:	6a 01                	push   $0x1
    3606:	e8 c5 04 00 00       	call   3ad0 <printf>
}
    ...
    3613:	51                   	push   %ecx
    3614:	51                   	push   %ecx
    3615:	68 f8 4d 00 00       	push   $0x4df8
    361a:	6a 02                	push   $0x2
    361c:	e8 af 04 00 00       	call   3ad0 <printf>
    exit();
    3621:	e8 55 03 00 00       	call   397b <exit>
    3626:	8d 76 00             	lea    0x0(%esi),%esi
    3629:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003630 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 50 5f 00 00 0d 	imul   $0x19660d,0x5f50,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3643:	a3 50 5f 00 00       	mov    %eax,0x5f50
}
    3648:	c3                   	ret    
    ...
    3768:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3780:	50                   	push   %eax
    3781:	6a 00                	push   $0x0
    3783:	e8 0b 02 00 00       	call   3993 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    37ed:	e8 c9 01 00 00       	call   39bb <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3801:	50                   	push   %eax
    3802:	e8 cc 01 00 00       	call   39d3 <fstat>
  close(fd);
    3807:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    380a:	89 c6                	mov    %eax,%esi
  close(fd);
    380c:	e8 92 01 00 00       	call   39a3 <close>
  return r;
...
000038a0 <writeBuffer>:

int writeBuffer(char* buff, char* va)
{
    38a0:	55                   	push   %ebp
  int x = 0;
    38a1:	31 c9                	xor    %ecx,%ecx
{
    38a3:	89 e5                	mov    %esp,%ebp
    38a5:	56                   	push   %esi
    38a6:	53                   	push   %ebx
    38a7:	8b 75 0c             	mov    0xc(%ebp),%esi
    38aa:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char* temp = va;
  while (*buff != '.')
    38ad:	89 f0                	mov    %esi,%eax
    38af:	0f b6 13             	movzbl (%ebx),%edx
    38b2:	eb 09                	jmp    38bd <writeBuffer+0x1d>
    38b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  {
    if (*va == 'A')
    38b8:	80 38 41             	cmpb   $0x41,(%eax)
    38bb:	74 13                	je     38d0 <writeBuffer+0x30>
  while (*buff != '.')
    38bd:	80 fa 2e             	cmp    $0x2e,%dl
    38c0:	75 f6                	jne    38b8 <writeBuffer+0x18>
        va = temp;
      else
        va++;
    }
  ...
  *va = '.';
  ...
  return 1;
    ...
    38ce:	66 90                	xchg   %ax,%ax
      x = (x + 1)%4096;
    38d0:	83 c1 01             	add    $0x1,%ecx
      *va = *buff;
    38d3:	88 10                	mov    %dl,(%eax)
      buff++;
    38d5:	83 c3 01             	add    $0x1,%ebx
        va++;
    38d8:	83 c0 01             	add    $0x1,%eax
    38db:	81 e1 ff 0f 00 00    	and    $0xfff,%ecx
    38e1:	0f 44 c6             	cmove  %esi,%eax
    38e4:	eb c9                	jmp    38af <writeBuffer+0xf>
...
int readBuffer(char* va)
{
    ...
    38f5:	53                   	push   %ebx
  int c = 0, x = 0;
    38f6:	31 f6                	xor    %esi,%esi
    38f8:	31 db                	xor    %ebx,%ebx
{
    38fa:	83 ec 0c             	sub    $0xc,%esp
  char* temp = va;
  while (*va != '.')
    38fd:	8b 7d 08             	mov    0x8(%ebp),%edi
    3900:	0f be 07             	movsbl (%edi),%eax
    3903:	3c 2e                	cmp    $0x2e,%al
    3905:	74 40                	je     3947 <readBuffer+0x57>
    3907:	89 f6                	mov    %esi,%esi
    3909:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  {
    if (*va != 'A')
    3910:	3c 41                	cmp    $0x41,%al
    3912:	74 fc                	je     3910 <readBuffer+0x20>
    {
      printf(1,"%c", *va);
    3914:	83 ec 04             	sub    $0x4,%esp
      x = (x+1)%4096;
      c++; 
      if (x == 0)
        va = temp;
        ...
        va++;
    3917:	83 c7 01             	add    $0x1,%edi
      c++; 
    391a:	83 c3 01             	add    $0x1,%ebx
      printf(1,"%c", *va);
    391d:	50                   	push   %eax
    391e:	68 be 55 00 00       	push   $0x55be
    3923:	6a 01                	push   $0x1
    3925:	e8 a6 01 00 00       	call   3ad0 <printf>
      x = (x+1)%4096;
    392a:	8d 56 01             	lea    0x1(%esi),%edx
      *va = 'A';
    392d:	c6 47 ff 41          	movb   $0x41,-0x1(%edi)
      if (x == 0)
    3931:	83 c4 10             	add    $0x10,%esp
        va++;
    3934:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    393a:	0f 44 7d 08          	cmove  0x8(%ebp),%edi
    393e:	89 d6                	mov    %edx,%esi
  while (*va != '.')
    3940:	0f be 07             	movsbl (%edi),%eax
    3943:	3c 2e                	cmp    $0x2e,%al
    3945:	75 c9                	jne    3910 <readBuffer+0x20>
    }
  }
  printf(1,"\n");
    3947:	83 ec 08             	sub    $0x8,%esp
    394a:	68 4a 42 00 00       	push   $0x424a
    394f:	6a 01                	push   $0x1
    3951:	e8 7a 01 00 00       	call   3ad0 <printf>
  printf(1,"The value of the counter is %d\n", c);
    3956:	83 c4 0c             	add    $0xc,%esp
    3959:	53                   	push   %ebx
    395a:	68 c4 55 00 00       	push   $0x55c4
    395f:	6a 01                	push   $0x1
    3961:	e8 6a 01 00 00       	call   3ad0 <printf>
  return 1;
    3966:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
SYSCALL(fork)
    3973:	b8 01 00 00 00       	mov    $0x1,%eax
    3978:	cd 40                	int    $0x40
    397a:	c3                   	ret    

0000397b <exit>:
SYSCALL(exit)
    397b:	b8 02 00 00 00       	mov    $0x2,%eax
    3980:	cd 40                	int    $0x40
    3982:	c3                   	ret    

00003983 <wait>:
SYSCALL(wait)
    3983:	b8 03 00 00 00       	mov    $0x3,%eax
    3988:	cd 40                	int    $0x40
    398a:	c3                   	ret    

0000398b <pipe>:
SYSCALL(pipe)
    398b:	b8 04 00 00 00       	mov    $0x4,%eax
    3990:	cd 40                	int    $0x40
    3992:	c3                   	ret    

00003993 <read>:
SYSCALL(read)
    3993:	b8 05 00 00 00       	mov    $0x5,%eax
    3998:	cd 40                	int    $0x40
    399a:	c3                   	ret    

0000399b <write>:
SYSCALL(write)
    399b:	b8 10 00 00 00       	mov    $0x10,%eax
    39a0:	cd 40                	int    $0x40
    39a2:	c3                   	ret    

000039a3 <close>:
SYSCALL(close)
    39a3:	b8 15 00 00 00       	mov    $0x15,%eax
    39a8:	cd 40                	int    $0x40
    39aa:	c3                   	ret    

000039ab <kill>:
SYSCALL(kill)
    39ab:	b8 06 00 00 00       	mov    $0x6,%eax
    39b0:	cd 40                	int    $0x40
    39b2:	c3                   	ret    

000039b3 <exec>:
SYSCALL(exec)
    39b3:	b8 07 00 00 00       	mov    $0x7,%eax
    39b8:	cd 40                	int    $0x40
    39ba:	c3                   	ret    

000039bb <open>:
SYSCALL(open)
    39bb:	b8 0f 00 00 00       	mov    $0xf,%eax
    39c0:	cd 40                	int    $0x40
    39c2:	c3                   	ret    

000039c3 <mknod>:
SYSCALL(mknod)
    39c3:	b8 11 00 00 00       	mov    $0x11,%eax
    39c8:	cd 40                	int    $0x40
    39ca:	c3                   	ret    

000039cb <unlink>:
SYSCALL(unlink)
    39cb:	b8 12 00 00 00       	mov    $0x12,%eax
    39d0:	cd 40                	int    $0x40
    39d2:	c3                   	ret    

000039d3 <fstat>:
SYSCALL(fstat)
    39d3:	b8 08 00 00 00       	mov    $0x8,%eax
    39d8:	cd 40                	int    $0x40
    39da:	c3                   	ret    

000039db <link>:
SYSCALL(link)
    39db:	b8 13 00 00 00       	mov    $0x13,%eax
    39e0:	cd 40                	int    $0x40
    39e2:	c3                   	ret    

000039e3 <mkdir>:
SYSCALL(mkdir)
    39e3:	b8 14 00 00 00       	mov    $0x14,%eax
    39e8:	cd 40                	int    $0x40
    39ea:	c3                   	ret    

000039eb <chdir>:
SYSCALL(chdir)
    39eb:	b8 09 00 00 00       	mov    $0x9,%eax
    39f0:	cd 40                	int    $0x40
    39f2:	c3                   	ret    

000039f3 <dup>:
SYSCALL(dup)
    39f3:	b8 0a 00 00 00       	mov    $0xa,%eax
    39f8:	cd 40                	int    $0x40
    39fa:	c3                   	ret    

000039fb <getpid>:
SYSCALL(getpid)
    39fb:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a00:	cd 40                	int    $0x40
    3a02:	c3                   	ret    

00003a03 <sbrk>:
SYSCALL(sbrk)
    3a03:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a08:	cd 40                	int    $0x40
    3a0a:	c3                   	ret    

00003a0b <sleep>:
SYSCALL(sleep)
    3a0b:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a10:	cd 40                	int    $0x40
    3a12:	c3                   	ret    

00003a13 <uptime>:
SYSCALL(uptime)
    3a13:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a18:	cd 40                	int    $0x40
    3a1a:	c3                   	ret    

00003a1b <attachpage>:
SYSCALL(attachpage)
    3a1b:	b8 16 00 00 00       	mov    $0x16,%eax
    3a20:	cd 40                	int    $0x40
    3a22:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    3a39:	85 d2                	test   %edx,%edx
{
    3a3b:	89 45 c0             	mov    %eax,-0x40(%ebp)
    neg = 1;
    x = -xx;
    3a3e:	89 d0                	mov    %edx,%eax
  if(sgn && xx < 0){
    3a40:	79 76                	jns    3ab8 <printint+0x88>
    3a42:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3a46:	74 70                	je     3ab8 <printint+0x88>
    x = -xx;
    3a48:	f7 d8                	neg    %eax
    neg = 1;
    3a4a:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    3a51:	31 f6                	xor    %esi,%esi
    3a53:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    3a56:	eb 0a                	jmp    3a62 <printint+0x32>
    3a58:	90                   	nop
    3a59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  do{
    buf[i++] = digits[x % base];
    3a60:	89 fe                	mov    %edi,%esi
    3a62:	31 d2                	xor    %edx,%edx
    3a64:	8d 7e 01             	lea    0x1(%esi),%edi
    3a67:	f7 f1                	div    %ecx
    3a69:	0f b6 92 ec 55 00 00 	movzbl 0x55ec(%edx),%edx
  }while((x /= base) != 0);
    3a70:	85 c0                	test   %eax,%eax
    buf[i++] = digits[x % base];
    3a72:	88 14 3b             	mov    %dl,(%ebx,%edi,1)
  }while((x /= base) != 0);
    3a75:	75 e9                	jne    3a60 <printint+0x30>
  if(neg)
    3a77:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    3a7a:	85 c0                	test   %eax,%eax
    3a7c:	74 08                	je     3a86 <printint+0x56>
    buf[i++] = '-';
    3a7e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    3a83:	8d 7e 02             	lea    0x2(%esi),%edi
    3a86:	8d 74 3d d7          	lea    -0x29(%ebp,%edi,1),%esi
    3a8a:	8b 7d c0             	mov    -0x40(%ebp),%edi
    3a8d:	8d 76 00             	lea    0x0(%esi),%esi
    3a90:	0f b6 06             	movzbl (%esi),%eax
  write(fd, &c, 1);
    3a93:	83 ec 04             	sub    $0x4,%esp
    3a96:	83 ee 01             	sub    $0x1,%esi
    3a99:	6a 01                	push   $0x1
    3a9b:	53                   	push   %ebx
    3a9c:	57                   	push   %edi
    3a9d:	88 45 d7             	mov    %al,-0x29(%ebp)
    3aa0:	e8 f6 fe ff ff       	call   399b <write>

  while(--i >= 0)
    3aa5:	83 c4 10             	add    $0x10,%esp
    3aa8:	39 de                	cmp    %ebx,%esi
    3aaa:	75 e4                	jne    3a90 <printint+0x60>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
    3ab8:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    3abf:	eb 90                	jmp    3a51 <printint+0x21>
    3ac1:	eb 0d                	jmp    3ad0 <printf>
    3ac3:	90                   	nop
    3ac4:	90                   	nop
    3ac5:	90                   	nop
    3ac6:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3ad9:	8b 75 0c             	mov    0xc(%ebp),%esi
    3adc:	0f b6 1e             	movzbl (%esi),%ebx
    3adf:	84 db                	test   %bl,%bl
    3ae1:	0f 84 b3 00 00 00    	je     3b9a <printf+0xca>
  ap = (uint*)(void*)&fmt + 1;
    3ae7:	8d 45 10             	lea    0x10(%ebp),%eax
    3aea:	83 c6 01             	add    $0x1,%esi
  state = 0;
    3aed:	31 ff                	xor    %edi,%edi
  ap = (uint*)(void*)&fmt + 1;
    3aef:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    3af2:	eb 2f                	jmp    3b23 <printf+0x53>
    3af4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    3af8:	83 f8 25             	cmp    $0x25,%eax
    3afb:	0f 84 a7 00 00 00    	je     3ba8 <printf+0xd8>
  write(fd, &c, 1);
    3b01:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    3b04:	83 ec 04             	sub    $0x4,%esp
    3b07:	88 5d e2             	mov    %bl,-0x1e(%ebp)
    3b0a:	6a 01                	push   $0x1
    3b0c:	50                   	push   %eax
    3b0d:	ff 75 08             	pushl  0x8(%ebp)
    3b10:	e8 86 fe ff ff       	call   399b <write>
    3b15:	83 c4 10             	add    $0x10,%esp
    3b18:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
    3b1b:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    3b1f:	84 db                	test   %bl,%bl
    3b21:	74 77                	je     3b9a <printf+0xca>
    if(state == 0){
    3b23:	85 ff                	test   %edi,%edi
    c = fmt[i] & 0xff;
    3b25:	0f be cb             	movsbl %bl,%ecx
    3b28:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3b2b:	74 cb                	je     3af8 <printf+0x28>
        state = '%';
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    3b2d:	83 ff 25             	cmp    $0x25,%edi
    3b30:	75 e6                	jne    3b18 <printf+0x48>
      if(c == 'd'){
    3b32:	83 f8 64             	cmp    $0x64,%eax
    3b35:	0f 84 05 01 00 00    	je     3c40 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3b3b:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    3b41:	83 f9 70             	cmp    $0x70,%ecx
    3b44:	74 72                	je     3bb8 <printf+0xe8>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3b46:	83 f8 73             	cmp    $0x73,%eax
    3b49:	0f 84 99 00 00 00    	je     3be8 <printf+0x118>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3b4f:	83 f8 63             	cmp    $0x63,%eax
    3b52:	0f 84 08 01 00 00    	je     3c60 <printf+0x190>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3b58:	83 f8 25             	cmp    $0x25,%eax
    3b5b:	0f 84 ef 00 00 00    	je     3c50 <printf+0x180>
  write(fd, &c, 1);
    3b61:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3b64:	83 ec 04             	sub    $0x4,%esp
    3b67:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3b6b:	6a 01                	push   $0x1
    3b6d:	50                   	push   %eax
    3b6e:	ff 75 08             	pushl  0x8(%ebp)
    3b71:	e8 25 fe ff ff       	call   399b <write>
    3b76:	83 c4 0c             	add    $0xc,%esp
    3b79:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    3b7c:	88 5d e6             	mov    %bl,-0x1a(%ebp)
    3b7f:	6a 01                	push   $0x1
    3b81:	50                   	push   %eax
    3b82:	ff 75 08             	pushl  0x8(%ebp)
    3b85:	83 c6 01             	add    $0x1,%esi
      } else {
      ...
      state = 0;
    3b88:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    3b8a:	e8 0c fe ff ff       	call   399b <write>
  for(i = 0; fmt[i]; i++){
    3b8f:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
  write(fd, &c, 1);
    3b93:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3b96:	84 db                	test   %bl,%bl
    3b98:	75 89                	jne    3b23 <printf+0x53>
    }
  }
}
    3b9a:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b9d:	5b                   	pop    %ebx
    3b9e:	5e                   	pop    %esi
    3b9f:	5f                   	pop    %edi
    3ba0:	5d                   	pop    %ebp
    ...
    3ba2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        state = '%';
    3ba8:	bf 25 00 00 00       	mov    $0x25,%edi
    3bad:	e9 66 ff ff ff       	jmp    3b18 <printf+0x48>
    3bb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3bb8:	83 ec 0c             	sub    $0xc,%esp
    3bbb:	b9 10 00 00 00       	mov    $0x10,%ecx
    3bc0:	6a 00                	push   $0x0
    3bc2:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    3bc5:	8b 45 08             	mov    0x8(%ebp),%eax
    3bc8:	8b 17                	mov    (%edi),%edx
    3bca:	e8 61 fe ff ff       	call   3a30 <printint>
        ap++;
    3bcf:	89 f8                	mov    %edi,%eax
    3bd1:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3bd4:	31 ff                	xor    %edi,%edi
        ap++;
    3bd6:	83 c0 04             	add    $0x4,%eax
    3bd9:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    3bdc:	e9 37 ff ff ff       	jmp    3b18 <printf+0x48>
    3be1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    3be8:	8b 45 d4             	mov    -0x2c(%ebp),%eax
    3beb:	8b 08                	mov    (%eax),%ecx
        ap++;
    3bed:	83 c0 04             	add    $0x4,%eax
    3bf0:	89 45 d4             	mov    %eax,-0x2c(%ebp)
        if(s == 0)
    3bf3:	85 c9                	test   %ecx,%ecx
    3bf5:	0f 84 8e 00 00 00    	je     3c89 <printf+0x1b9>
        while(*s != 0){
    3bfb:	0f b6 01             	movzbl (%ecx),%eax
      state = 0;
    3bfe:	31 ff                	xor    %edi,%edi
        s = (char*)*ap;
    3c00:	89 cb                	mov    %ecx,%ebx
        while(*s != 0){
    3c02:	84 c0                	test   %al,%al
    3c04:	0f 84 0e ff ff ff    	je     3b18 <printf+0x48>
    3c0a:	89 75 d0             	mov    %esi,-0x30(%ebp)
    3c0d:	89 de                	mov    %ebx,%esi
    3c0f:	8b 5d 08             	mov    0x8(%ebp),%ebx
    3c12:	8d 7d e3             	lea    -0x1d(%ebp),%edi
    3c15:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    3c18:	83 ec 04             	sub    $0x4,%esp
          s++;
    3c1b:	83 c6 01             	add    $0x1,%esi
    3c1e:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    3c21:	6a 01                	push   $0x1
    3c23:	57                   	push   %edi
    3c24:	53                   	push   %ebx
    3c25:	e8 71 fd ff ff       	call   399b <write>
        while(*s != 0){
    3c2a:	0f b6 06             	movzbl (%esi),%eax
    3c2d:	83 c4 10             	add    $0x10,%esp
    3c30:	84 c0                	test   %al,%al
    3c32:	75 e4                	jne    3c18 <printf+0x148>
    3c34:	8b 75 d0             	mov    -0x30(%ebp),%esi
      state = 0;
    3c37:	31 ff                	xor    %edi,%edi
    3c39:	e9 da fe ff ff       	jmp    3b18 <printf+0x48>
    3c3e:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 10, 1);
    3c40:	83 ec 0c             	sub    $0xc,%esp
    3c43:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3c48:	6a 01                	push   $0x1
    3c4a:	e9 73 ff ff ff       	jmp    3bc2 <printf+0xf2>
    3c4f:	90                   	nop
  write(fd, &c, 1);
    3c50:	83 ec 04             	sub    $0x4,%esp
    3c53:	88 5d e5             	mov    %bl,-0x1b(%ebp)
    3c56:	8d 45 e5             	lea    -0x1b(%ebp),%eax
    3c59:	6a 01                	push   $0x1
    3c5b:	e9 21 ff ff ff       	jmp    3b81 <printf+0xb1>
        putc(fd, *ap);
    3c60:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  write(fd, &c, 1);
    3c63:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    3c66:	8b 07                	mov    (%edi),%eax
  write(fd, &c, 1);
    3c68:	6a 01                	push   $0x1
        ap++;
    3c6a:	83 c7 04             	add    $0x4,%edi
        putc(fd, *ap);
    3c6d:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    3c70:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    3c73:	50                   	push   %eax
    3c74:	ff 75 08             	pushl  0x8(%ebp)
    3c77:	e8 1f fd ff ff       	call   399b <write>
        ap++;
    3c7c:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    3c7f:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3c82:	31 ff                	xor    %edi,%edi
    3c84:	e9 8f fe ff ff       	jmp    3b18 <printf+0x48>
          s = "(null)";
    3c89:	bb e4 55 00 00       	mov    $0x55e4,%ebx
        while(*s != 0){
    3c8e:	b8 28 00 00 00       	mov    $0x28,%eax
    3c93:	e9 72 ff ff ff       	jmp    3c0a <printf+0x13a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3ca1:	a1 00 60 00 00       	mov    0x6000,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cb8:	39 c8                	cmp    %ecx,%eax
    3cba:	8b 10                	mov    (%eax),%edx
    3cbc:	73 32                	jae    3cf0 <free+0x50>
    3cbe:	39 d1                	cmp    %edx,%ecx
    3cc0:	72 04                	jb     3cc6 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3cc2:	39 d0                	cmp    %edx,%eax
    3cc4:	72 32                	jb     3cf8 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3cc6:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3cc9:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3ccc:	39 fa                	cmp    %edi,%edx
    3cce:	74 30                	je     3d00 <free+0x60>
  ...
  if(p + p->s.size == bp){
    3cd3:	8b 50 04             	mov    0x4(%eax),%edx
    3cd6:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3cd9:	39 f1                	cmp    %esi,%ecx
    3cdb:	74 3a                	je     3d17 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3cdd:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3cdf:	a3 00 60 00 00       	mov    %eax,0x6000
}
    3ce4:	5b                   	pop    %ebx
    3ce5:	5e                   	pop    %esi
    3ce6:	5f                   	pop    %edi
    ...
    3cf2:	72 04                	jb     3cf8 <free+0x58>
    3cf4:	39 d1                	cmp    %edx,%ecx
    3cf6:	72 ce                	jb     3cc6 <free+0x26>
{
    3cf8:	89 d0                	mov    %edx,%eax
    3cfa:	eb bc                	jmp    3cb8 <free+0x18>
  ...
  if(p + p->s.size == bp){
    ...
    3d15:	75 c6                	jne    3cdd <free+0x3d>
    p->s.size += bp->s.size;
    3d17:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    3d1a:	a3 00 60 00 00       	mov    %eax,0x6000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d3c:	8b 15 00 60 00 00    	mov    0x6000,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3d42:	8d 78 07             	lea    0x7(%eax),%edi
    3d45:	c1 ef 03             	shr    $0x3,%edi
    3d48:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    3d4b:	85 d2                	test   %edx,%edx
    3d4d:	0f 84 9d 00 00 00    	je     3df0 <malloc+0xc0>
    3d53:	8b 02                	mov    (%edx),%eax
    3d55:	8b 48 04             	mov    0x4(%eax),%ecx
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d5a:	76 6c                	jbe    3dc8 <malloc+0x98>
    3d5c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    3d62:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3d67:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    3d6a:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    3d71:	eb 0e                	jmp    3d81 <malloc+0x51>
    3d73:	90                   	nop
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d7d:	39 f9                	cmp    %edi,%ecx
    3d7f:	73 47                	jae    3dc8 <malloc+0x98>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3d81:	39 05 00 60 00 00    	cmp    %eax,0x6000
    3d87:	89 c2                	mov    %eax,%edx
    3d89:	75 ed                	jne    3d78 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    3d8b:	83 ec 0c             	sub    $0xc,%esp
    3d8e:	56                   	push   %esi
    3d8f:	e8 6f fc ff ff       	call   3a03 <sbrk>
  if(p == (char*)-1)
    3d94:	83 c4 10             	add    $0x10,%esp
    3d97:	83 f8 ff             	cmp    $0xffffffff,%eax
    3d9a:	74 1c                	je     3db8 <malloc+0x88>
  hp->s.size = nu;
    3d9c:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3d9f:	83 ec 0c             	sub    $0xc,%esp
    3da2:	83 c0 08             	add    $0x8,%eax
    3da5:	50                   	push   %eax
    3da6:	e8 f5 fe ff ff       	call   3ca0 <free>
  return freep;
    3dab:	8b 15 00 60 00 00    	mov    0x6000,%edx
      if((p = morecore(nunits)) == 0)
    3db1:	83 c4 10             	add    $0x10,%esp
    3db4:	85 d2                	test   %edx,%edx
    3db6:	75 c0                	jne    3d78 <malloc+0x48>
        return 0;
  }
}
    ...
    3dc0:	5d                   	pop    %ebp
    3dc1:	c3                   	ret    
    3dc2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3dc8:	39 cf                	cmp    %ecx,%edi
    3dca:	74 54                	je     3e20 <malloc+0xf0>
        p->s.size -= nunits;
    3dcc:	29 f9                	sub    %edi,%ecx
    3dce:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3dd1:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3dd4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3dd7:	89 15 00 60 00 00    	mov    %edx,0x6000
}
    3ddd:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    3de0:	83 c0 08             	add    $0x8,%eax
}
    3de3:	5b                   	pop    %ebx
    3de4:	5e                   	pop    %esi
    3de5:	5f                   	pop    %edi
    ...
    base.s.ptr = freep = prevp = &base;
    3df0:	c7 05 00 60 00 00 04 	movl   $0x6004,0x6000
    3df7:	60 00 00 
    3dfa:	c7 05 04 60 00 00 04 	movl   $0x6004,0x6004
    3e01:	60 00 00 
    base.s.size = 0;
    3e04:	b8 04 60 00 00       	mov    $0x6004,%eax
    3e09:	c7 05 08 60 00 00 00 	movl   $0x0,0x6008
    3e10:	00 00 00 
    3e13:	e9 44 ff ff ff       	jmp    3d5c <malloc+0x2c>
    3e18:	90                   	nop
    3e19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        prevp->s.ptr = p->s.ptr;
    3e20:	8b 08                	mov    (%eax),%ecx
    3e22:	89 0a                	mov    %ecx,(%edx)
    3e24:	eb b1                	jmp    3dd7 <malloc+0xa7>
