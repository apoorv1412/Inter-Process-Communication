...
80101ed8:	68 62 77 10 80       	push   $0x80107762
...
80102332:	81 fb 40 74 11 80    	cmp    $0x80117440,%ebx
...
80102ec7:	68 40 74 11 80       	push   $0x80117440
...
801040ea:	68 78 76 10 80       	push   $0x80107678
...
80104305:	68 83 76 10 80       	push   $0x80107683
8010430a:	e8 81 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010430f:	83 ec 0c             	sub    $0xc,%esp
80104312:	68 9a 76 10 80       	push   $0x8010769a
...
801043f7:	68 a1 76 10 80       	push   $0x801076a1
...
8010444c:	68 a9 76 10 80       	push   $0x801076a9
...
8010486c:	8b 14 85 e0 76 10 80 	mov    -0x7fef8920(,%eax,4),%edx
...
801049e4:	68 58 77 10 80       	push   $0x80107758
...
801049fc:	68 57 77 10 80       	push   $0x80107757
...
80104a15:	68 4b 77 10 80       	push   $0x8010774b
...
80104a2a:	68 5a 77 10 80       	push   $0x8010775a
80104a2f:	e8 5c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a34:	83 ec 0c             	sub    $0xc,%esp
80104a37:	68 3c 77 10 80       	push   $0x8010773c
...
80104e29:	58                   	pop    %eax
80104e2a:	5a                   	pop    %edx
80104e2b:	68 58 77 10 80       	push   $0x80107758
...
80104e44:	68 57 77 10 80       	push   $0x80107757
...
80105640 <sys_attachpage>:

//The system call attaches the page to the process which called it

int sys_attachpage(void) 
{
...
80105656:	78 18                	js     80105670 <sys_attachpage+0x30>
		return -1;
	return shm_create(key);
80105658:	83 ec 0c             	sub    $0xc,%esp
8010565b:	ff 75 f4             	pushl  -0xc(%ebp)
8010565e:	e8 9d 18 00 00       	call   80106f00 <shm_create>
...
801056ee:	00 00 ef 
  initlock(&tickslock, "time");
801056f1:	68 9d 77 10 80       	push   $0x8010779d
...
80105770:	ff 24 85 44 78 10 80 	jmp    *-0x7fef87bc(,%eax,4)
...
801057d5:	68 00 78 10 80       	push   $0x80107800
...
80105917:	68 a8 77 10 80       	push   $0x801077a8
...
801059b5:	68 cc 77 10 80       	push   $0x801077cc
801059ba:	e8 a1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059bf:	83 c4 14             	add    $0x14,%esp
801059c2:	68 a2 77 10 80       	push   $0x801077a2
...
80105abc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105abf:	bb c4 78 10 80       	mov    $0x801078c4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801066cd:	68 cc 78 10 80       	push   $0x801078cc
...
80106772:	68 66 72 10 80       	push   $0x80107266
...
80106810:	a1 e0 54 11 80       	mov    0x801154e0,%eax
{
...
801069a9:	68 11 79 10 80       	push   $0x80107911
...
80106b0d:	68 49 79 10 80       	push   $0x80107949
...
80106b43:	68 61 79 10 80       	push   $0x80107961
...
80106c4c:	68 7d 79 10 80       	push   $0x8010797d
...
80106ceb:	a3 e0 54 11 80       	mov    %eax,0x801154e0
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106d1f:	68 8e 79 10 80       	push   $0x8010798e
...
80106dc5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106dc8:	e8 03 b7 ff ff       	call   801024d0 <kalloc>
...
80106f05:	53                   	push   %ebx
    ...
    /*
    Searches for free virtual address
    */
    while (x < KERNBASE)
80106f06:	31 ff                	xor    %edi,%edi
    uint x = 0;
80106f08:	31 db                	xor    %ebx,%ebx
{
80106f0a:	83 ec 0c             	sub    $0xc,%esp
    pte_t* pgdir = myproc()->pgdir;
80106f0d:	e8 de c8 ff ff       	call   801037f0 <myproc>
80106f12:	8b 70 04             	mov    0x4(%eax),%esi
80106f15:	8d 76 00             	lea    0x0(%esi),%esi
    { 
        void* va = (void*) x;
        pte_t* y = walkpgdir(pgdir, va, 0);
80106f18:	31 c9                	xor    %ecx,%ecx
80106f1a:	89 da                	mov    %ebx,%edx
80106f1c:	89 f0                	mov    %esi,%eax
80106f1e:	e8 ad f6 ff ff       	call   801065d0 <walkpgdir>
        if (y != 0 && (*y & PTE_P) == 0)
80106f23:	85 c0                	test   %eax,%eax
80106f25:	74 05                	je     80106f2c <shm_create+0x2c>
80106f27:	f6 00 01             	testb  $0x1,(%eax)
80106f2a:	74 0c                	je     80106f38 <shm_create+0x38>
            break;
        x += PG_SIZE;
80106f2c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    while (x < KERNBASE)
80106f32:	85 db                	test   %ebx,%ebx
80106f34:	89 df                	mov    %ebx,%edi
80106f36:	79 e0                	jns    80106f18 <shm_create+0x18>
    }

    int index = -1;
    for (int i = 0; i < ctr; ++i)
80106f38:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
80106f3e:	85 d2                	test   %edx,%edx
80106f40:	7e 2e                	jle    80106f70 <shm_create+0x70>
    {
        if (key == memory_segment_key[i])
80106f42:	a1 00 55 11 80       	mov    0x80115500,%eax
80106f47:	39 45 08             	cmp    %eax,0x8(%ebp)
    for (int i = 0; i < ctr; ++i)
80106f4a:	b8 00 00 00 00       	mov    $0x0,%eax
        if (key == memory_segment_key[i])
80106f4f:	74 77                	je     80106fc8 <shm_create+0xc8>
80106f51:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106f54:	eb 13                	jmp    80106f69 <shm_create+0x69>
80106f56:	8d 76 00             	lea    0x0(%esi),%esi
80106f59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80106f60:	39 0c 85 00 55 11 80 	cmp    %ecx,-0x7feeab00(,%eax,4)
80106f67:	74 5f                	je     80106fc8 <shm_create+0xc8>
    for (int i = 0; i < ctr; ++i)
80106f69:	83 c0 01             	add    $0x1,%eax
80106f6c:	39 c2                	cmp    %eax,%edx
80106f6e:	75 f0                	jne    80106f60 <shm_create+0x60>

    /*
    Memory has to be allotted
    */

    char* pa = kalloc();
80106f70:	e8 5b b5 ff ff       	call   801024d0 <kalloc>

    if (ctr >= M)
80106f75:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
80106f7b:	81 fa e7 03 00 00    	cmp    $0x3e7,%edx
80106f81:	7f 72                	jg     80106ff5 <shm_create+0xf5>
        return -1;


    physical_address[ctr] = pa;
    memory_segment_key[ctr] = key;
80106f83:	8b 4d 08             	mov    0x8(%ebp),%ecx
    mappages(pgdir, va, PG_SIZE, V2P(pa), PTE_W | PTE_U);
80106f86:	83 ec 08             	sub    $0x8,%esp
    physical_address[ctr] = pa;
80106f89:	89 04 95 a0 64 11 80 	mov    %eax,-0x7fee9b60(,%edx,4)
    mappages(pgdir, va, PG_SIZE, V2P(pa), PTE_W | PTE_U);
80106f90:	05 00 00 00 80       	add    $0x80000000,%eax
80106f95:	6a 06                	push   $0x6
80106f97:	50                   	push   %eax
80106f98:	89 f0                	mov    %esi,%eax
    memory_segment_key[ctr] = key;
80106f9a:	89 0c 95 00 55 11 80 	mov    %ecx,-0x7feeab00(,%edx,4)
    mappages(pgdir, va, PG_SIZE, V2P(pa), PTE_W | PTE_U);
80106fa1:	89 da                	mov    %ebx,%edx
80106fa3:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106fa8:	e8 a3 f6 ff ff       	call   80106650 <mappages>

    ++ctr;
80106fad:	83 05 c0 a5 10 80 01 	addl   $0x1,0x8010a5c0
...
80106fc1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        mappages(pgdir, va, PG_SIZE, V2P(physical_address[index]), PTE_W | PTE_U);
80106fc8:	8b 04 85 a0 64 11 80 	mov    -0x7fee9b60(,%eax,4),%eax
80106fcf:	83 ec 08             	sub    $0x8,%esp
80106fd2:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106fd7:	6a 06                	push   $0x6
80106fd9:	89 da                	mov    %ebx,%edx
80106fdb:	05 00 00 00 80       	add    $0x80000000,%eax
80106fe0:	50                   	push   %eax
80106fe1:	89 f0                	mov    %esi,%eax
80106fe3:	e8 68 f6 ff ff       	call   80106650 <mappages>
        return x;
...
80106ff4:	c3                   	ret    
        return -1;
80106ff5:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80106ffa:	eb ef                	jmp    80106feb <shm_create+0xeb>
