...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 c1 03 00 00       	call   3fb <unlink>
...
free(void *ap)
{
 ...
 6d1:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 70d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 70f:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
 714:	5b                   	pop    %ebx
 715:	5e                   	pop    %esi
 716:	5f                   	pop    %edi
 ...
 726:	72 ce                	jb     6f6 <free+0x26>
{
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 74a:	a3 b8 0b 00 00       	mov    %eax,0xbb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7af:	73 47                	jae    7f8 <malloc+0x98>
    ...
    if(p == freep)
 7b1:	39 05 b8 0b 00 00    	cmp    %eax,0xbb8
 ...
 7d6:	e8 f5 fe ff ff       	call   6d0 <free>
  return freep;
 7db:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
 ...
 804:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 807:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 ...
 827:	0b 00 00 
 82a:	c7 05 bc 0b 00 00 bc 	movl   $0xbbc,0xbbc
 831:	0b 00 00 
    base.s.size = 0;
 834:	b8 bc 0b 00 00       	mov    $0xbbc,%eax
 839:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 840:	00 00 00 
